...
export function UiRecuperacaoDeSenhaClinicopsPage() {
  return (
    <section className="ui-stitch-screen" data-route="/ui/recuperacao-de-senha-clinicops" dangerouslySetInnerHTML={{ __html: screenHtml }} />
  );
}
