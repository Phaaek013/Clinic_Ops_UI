...
export function UiServicosLifemedClinicopsPage() {
  return (
    <section className="ui-stitch-screen" data-route="/ui/servicos-lifemed-clinicops">
      <html className="light" lang="pt-BR">
        <head>
          <meta charset="utf-8" />
          <meta content="width=device-width, initial-scale=1.0" name="viewport" />
          <title>
            Serviços - LifeMed ClinicOps
          </title>
          {/* Tailwind CSS */}
        ...
        <body className="bg-background-light dark:bg-background-dark min-h-screen flex flex-col font-display text-text-main">
          {/* Top Navigation */}
            ...
            <div className="px-4 md:px-10 lg:px-40 py-3 flex items-center justify-between">
              ...
              <div className="flex flex-1 justify-end gap-8 items-center">
                <nav className="hidden md:flex items-center gap-6 lg:gap-9">
                  <a className="text-text-main text-sm font-medium hover:text-primary transition-colors" href="#">
                    Início
                  </a>
                  <a className="text-primary text-sm font-bold border-b-2 border-primary pb-0.5" href="#">
                    Agendamentos
                  </a>
                  <a className="text-text-main text-sm font-medium hover:text-primary transition-colors" href="#">
                    Resultados
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="bg-center bg-no-repeat bg-cover rounded-full size-10 border border-border-light cursor-pointer" data-alt="Avatar do usuário logado" style={{backgroundImage: "url(\"/placeholder.svg\")"}}>
                  </div>
                  {/* Mobile Menu Trigger */}
          ...
          <main className="flex-grow">
            <div className="w-full max-w-[1280px] mx-auto px-4 md:px-10 lg:px-40 py-6 md:py-10">
              ...
              <div className="flex items-center gap-2 mb-4">
                <a className="text-text-secondary hover:text-primary text-sm font-medium transition-colors" href="#">
                  Início
                </a>
                <span className="text-text-secondary text-sm material-symbols-outlined text-[16px]">
                  chevron_right
                </span>
              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-8">
                <div className="max-w-2xl">
                  <h1 className="text-text-main text-3xl md:text-4xl font-bold tracking-tight mb-3">
                ...
                <div className="group bg-white rounded-2xl p-5 border border-border-light hover:border-primary/30 hover:shadow-lg transition-all duration-300 flex flex-col h-full">
                  <div className="flex justify-between items-start mb-4">
                    <div className="bg-[#e7f3f3] text-primary-dark p-3 rounded-xl">
                      <span className="material-symbols-outlined text-[28px] text-[#0d9494]">
                        cardiology
                      </span>
                    </div>
                  ...
                  <div className="mb-2">
                    <h3 className="text-lg font-bold text-text-main group-hover:text-[#0d9494] transition-colors">
                      Consulta Cardiológica
                    </h3>
                    <p className="text-sm text-text-secondary font-medium">
                      Dr. Ricardo Silva e Equipe
                    </p>
                  </div>
              ...
              <div className="border-t border-dashed border-border-light pt-10 mb-16">
                <div className="flex items-center gap-2 mb-6">
                  <span className="px-2 py-1 bg-gray-100 text-xs font-mono rounded text-gray-500">
                    UI States Preview
                  </span>
                  <h3 className="text-sm font-semibold text-text-secondary">
                    Componentes de status para feedback visual
                  </h3>
                </div>
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                  <div className="max-w-xl text-center md:text-left">
                    <h2 className="text-2xl md:text-3xl font-bold text-white mb-3">
                      Precisa de ajuda para encontrar o serviço ideal?
                    </h2>
                  ...
                  <div className="hidden md:block w-48 h-48 lg:w-64 lg:h-64 rounded-full overflow-hidden border-4 border-white/10 shadow-2xl flex-shrink-0">
                    <div className="w-full h-full bg-cover bg-center" data-alt="Médica sorrindo oferecendo ajuda ao paciente" style={{backgroundImage: "url(\"/placeholder.svg\")"}}>
                    </div>
                  </div>
                </div>
              </div>
