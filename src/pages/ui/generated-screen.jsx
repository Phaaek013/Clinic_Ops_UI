...
export function GeneratedScreen() {
  return (
    <div className="ui-page ui-generated-screen min-h-screen flex items-center justify-center p-4">
{/*BEGIN: MainContainer*/}
...
<div className="w-10 h-10 bg-accent rounded-lg flex items-center justify-center text-white font-extrabold text-xl">V</div>
<span className="text-2xl font-extrabold text-slate-800 tracking-tight">Clinic<span className="text-slate-500">Ops</span></span>
</div>
</div>
<h1 className="text-2xl font-bold text-slate-900 mb-2">Entrar no Portal</h1>
...
<label className="block text-sm font-semibold text-slate-700" htmlFor="email">E-mail Corporativo ou do Paciente</label>
...
<svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="/avatar.svg">
<path d="M2.036 12.322a1.012 1.012 0 010-.644C3.399 8.049 7.21 5 12 5c4.789 0 8.601 3.049 9.964 7.322a1.012 1.012 0 010 .644C20.601 15.95 16.79 19 12 19c-4.79 0-8.399-3.049-9.964-7.322z" strokeLinecap="round" strokeLinejoin="round"></path>
...
<svg className="h-4 w-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="/avatar.svg">
