...
export function CriarContaClinicopsCorrigido() {
  return (
    <div className="ui-page ui-criar-conta-clinicops-corrigido bg-background-light dark:bg-background-dark min-h-screen flex flex-col font-display transition-colors duration-300">
<main className="flex-1 flex flex-col items-center justify-center px-6 py-12">
{/*Logo Section*/}
<div className="mb-10 flex flex-col items-center gap-3">
<div className="flex items-center gap-3 text-primary">
<div className="size-10 flex items-center justify-center bg-primary/10 rounded-xl">
<svg className="size-7" fill="none" viewBox="0 0 48 48" xmlns="/avatar.svg">
...
<h1 className="text-2xl font-bold tracking-tight dark:text-white">ClinicOps</h1>
</div>
</div>
{/*Form Container*/}
...
<div className="relative group">
<span className="material-symbols-outlined absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-primary transition-colors">shield</span>
...
<label className="text-sm text-slate-600 dark:text-slate-400 leading-snug cursor-pointer select-none" htmlFor="terms">
                        Li e aceito os <a className="text-primary hover:underline font-medium" href="#">termos de uso</a> e <a className="text-primary hover:underline font-medium" href="#">políticas de privacidade</a>.
                    </label>
</div>
{/*Primary Button*/}
...
<p className="text-slate-600 dark:text-slate-400 text-sm">
                        Já tem uma conta? 
                        <a className="text-primary font-bold hover:underline ml-1" href="#">Entrar agora</a>
</p>
</div>
</form>
</div>
