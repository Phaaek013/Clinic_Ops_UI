...
export function UiAgendarContaPasso45Page() {
  return (
    <section className="ui-stitch-screen" data-route="/ui/agendar-conta-passo-4-5">
      <html className="light" lang="pt-BR">
        <head>
          <meta charset="utf-8" />
          <meta content="width=device-width, initial-scale=1.0" name="viewport" />
          <title>
            LifeMed ClinicOps - Agendar Passo 4
          </title>
        ...
        <body className="bg-background-light dark:bg-background-dark font-display text-text-main dark:text-gray-100 flex flex-col min-h-screen antialiased selection:bg-primary selection:text-text-main">
          {/* Top Navigation */}
          ...
          <main className="flex-grow w-full max-w-[1200px] mx-auto px-4 md:px-8 py-6 pb-24">
            ...
            <nav className="flex flex-wrap gap-2 py-2 mb-4 text-sm">
              <a className="text-teal-600 dark:text-primary font-medium hover:underline" href="#">
                Início
              </a>
            ...
            <div className="w-full mb-10 overflow-x-auto pb-2">
              <div className="min-w-[600px] flex items-center justify-between relative">
                ...
                <div className="flex flex-col items-center gap-2 group cursor-pointer">
                  ...
                  <span className="text-xs font-bold text-teal-700 dark:text-primary">
                    Especialidade
                  </span>
                </div>
                {/* Step 2: Done */}
                  ...
                  <form className="space-y-5" onSubmit="event.preventDefault();">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                      <div className="space-y-1.5 md:col-span-2">
                        <label className="block text-sm font-medium text-text-main dark:text-gray-200" htmlFor="name">
                          Nome Completo
                        </label>
                      ...
                      <div className="space-y-1.5">
                        <label className="block text-sm font-medium text-text-main dark:text-gray-200" htmlFor="phone">
                          Celular
                      ...
                      <div className="space-y-1.5">
                        <label className="block text-sm font-medium text-text-main dark:text-gray-200" htmlFor="birthdate">
                          Data de Nascimento
                        </label>
                        <div className="relative">
                          <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-slate-400">
                      ...
                      <div className="space-y-1.5">
                        <label className="block text-sm font-medium text-text-main dark:text-gray-200" htmlFor="confirm-password">
                          Confirmar Senha
                        </label>
                        <div className="relative">
                          <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-slate-400">
                    ...
                    <div className="pt-2">
                      <div className="flex items-start">
                        ...
                        <div className="ml-3 text-sm leading-6">
                          <label className="font-medium text-text-main dark:text-gray-200" htmlFor="terms">
                            Eu concordo com os Termos de Uso
                          </label>
                          <p className="text-slate-500 dark:text-slate-400">
                            Li e aceito a
                            <a className="text-teal-600 hover:text-teal-500 underline" href="#">
                              Política de Privacidade
                            </a>
                            e o processamento dos meus dados de saúde.
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500 dark:text-slate-400">
                        Seguimos rigorosamente a LGPD para proteção médica.
                      </p>
                    </div>
                  </div>
                ...
                <div className="sticky top-24 space-y-4">
                  <div className="bg-surface-light dark:bg-surface-dark rounded-2xl shadow-floating border border-slate-100 dark:border-slate-700 overflow-hidden">
                    ...
                    <div className="bg-gradient-to-r from-teal-50 to-cyan-50 dark:from-slate-800 dark:to-slate-800 px-6 py-4 border-b border-slate-100 dark:border-slate-700 flex justify-between items-center">
                      ...
                      <span className="bg-white dark:bg-slate-700 text-teal-700 dark:text-primary text-[10px] uppercase font-bold px-2 py-1 rounded border border-teal-100 dark:border-slate-600">
                        Passo 4/5
                      </span>
                    </div>
                    {/* Card Content */}
                    <div className="p-6 flex flex-col gap-6">
                      ...
                      <div className="flex items-center gap-4">
                        <div className="bg-primary/10 rounded-xl p-3 text-center min-w-[70px]">
                          <span className="block text-xs font-bold text-teal-700 dark:text-primary uppercase tracking-wide">
                            Out
                          </span>
                          <span className="block text-2xl font-bold text-text-main dark:text-white">
                            14
                          </span>
                        </div>
                        <div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex items-start gap-3">
                          <div className="size-8 rounded-full overflow-hidden bg-slate-200 mt-0.5 flex-shrink-0">
                            <img className="w-full h-full object-cover" data-alt="Portrait of Dr. Roberto Silva smiling professionally in a white coat" src="/placeholder.svg" />
                          </div>
                          <div>
                            <p className="text-xs text-slate-500 uppercase font-bold tracking-wider">
                              Profissional
                    ...
                    <div className="bg-amber-50 dark:bg-amber-900/20 px-6 py-3 border-t border-amber-100 dark:border-amber-800/30 flex items-start gap-2">
                      ...
                      <p className="text-xs text-amber-800 dark:text-amber-200 leading-relaxed">
                        Este horário está pré-reservado por
                        <span className="font-bold">
                          09:54
                        </span>
                        minutos. Complete o cadastro para confirmar.
                      </p>
                    </div>
                  </div>
                  {/* Map mini (Visual candy) */}
                  <div className="rounded-xl overflow-hidden h-32 relative shadow-card group">
                    <img className="w-full h-full object-cover opacity-80 group-hover:opacity-100 transition-opacity" data-alt="Top down view of a city map with streets and buildings" data-location="São Paulo" src="/placeholder.svg" />
