...
export function UiAgendarDataHoraPasso35Page() {
  return (
    <section className="ui-stitch-screen" data-route="/ui/agendar-data-hora-passo-3-5">
      <html className="light" lang="pt-BR">
        <head>
          <meta charset="utf-8" />
          <meta content="width=device-width, initial-scale=1.0" name="viewport" />
          <title>
            LifeMed ClinicOps - Agendar: Data
            &amp;
            Hora
          </title>
          {/* Tailwind CSS */}
          ...
          <script>
            ...
            colors: &#123;
            "primary": "#13ecec",
            "primary-hover": "#0ebaba",
            "primary-light": "#e0fcfc",
        ...
        <body className="bg-background-light dark:bg-background-dark font-display text-text-main antialiased selection:bg-primary/30">
          {/* Top Navigation */}
          <header className="sticky top-0 z-50 flex items-center justify-between whitespace-nowrap border-b border-solid border-border-light bg-surface-light/80 backdrop-blur-md px-10 py-3 dark:bg-surface-dark/90 dark:border-white/5">
            ...
            <div className="flex flex-1 justify-end gap-8">
              <nav className="hidden md:flex items-center gap-9">
                <a className="text-text-main dark:text-gray-200 text-sm font-medium hover:text-primary transition-colors" href="#">
                  Agendamentos
                </a>
                <a className="text-text-main dark:text-gray-200 text-sm font-medium hover:text-primary transition-colors" href="#">
                  Pacientes
              ...
              <div className="bg-center bg-no-repeat aspect-square bg-cover rounded-full size-10 border-2 border-primary/20 cursor-pointer hover:border-primary transition-colors" data-alt="User profile picture placeholder" style={{backgroundImage: "url(\"/placeholder.svg\")"}}>
              </div>
            </div>
          </header>
              ...
              <div className="mb-10 w-full">
                <div className="flex flex-col gap-3">
                  <div className="flex justify-between items-end">
                    ...
                    <span className="text-text-secondary dark:text-gray-500 text-xs font-semibold uppercase tracking-wider">
                      Data
                      &amp;
                      Hora
                    </span>
                  ...
                  <div className="relative h-2 w-full rounded-full bg-border-light dark:bg-white/10 overflow-hidden">
                    ...
                    <div className="absolute top-0 left-0 h-full w-[60%] rounded-full bg-primary transition-all duration-500 ease-out">
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="w-full max-w-[1100px] px-4 grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              <div className="lg:col-span-8 flex flex-col gap-6">
                ...
                <div className="flex items-center justify-between gap-4 rounded-xl border border-border-light bg-surface-light p-4 shadow-sm dark:bg-surface-dark dark:border-white/5 transition-all hover:border-primary/30">
                  <div className="flex items-center gap-4">
                    <div className="bg-center bg-no-repeat bg-cover rounded-full h-12 w-12 border border-border-light dark:border-white/10" data-alt="Photo of Dr. Silva" style={{backgroundImage: "url(\"/placeholder.svg\")"}}>
                    </div>
                    <div className="flex flex-col">
                      <p className="text-text-main dark:text-white text-base font-bold line-clamp-1">
                  ...
                  <div className="flex flex-col md:flex-row gap-8">
                    ...
                    <div className="flex-1 max-w-sm mx-auto md:mx-0">
                      ...
                      <div className="grid grid-cols-7 gap-y-2 text-center text-sm">
                        ...
                        <span className="py-2 text-gray-300 dark:text-gray-700">
                          25
                        </span>
                        <span className="py-2 text-gray-300 dark:text-gray-700">
                          26
                        ...
                        {/* Selected Day */}
                        <button className="mx-auto flex h-9 w-9 items-center justify-center rounded-full bg-primary text-text-main font-bold shadow-md ring-2 ring-primary ring-offset-2 ring-offset-white dark:ring-offset-surface-dark">
                          12
                        </button>
                        <span className="py-2">
                          13
                    ...
                    <div className="hidden md:block w-px bg-border-light dark:bg-white/10">
                    </div>
                    <div className="block md:hidden h-px w-full bg-border-light dark:bg-white/10">
                    </div>
                    {/* Time Slots Area */}
                    <div className="flex-1 flex flex-col">
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <span className="text-xs font-medium text-text-secondary bg-background-light dark:bg-white/5 px-2 py-1 rounded">
                          GMT-3
                        </span>
                      </div>
                      {/* Time Filters (Morning/Afternoon) */}
                      <div className="flex gap-2 mb-4">
                        <button className="text-xs font-semibold px-3 py-1.5 rounded-full bg-text-main text-white dark:bg-white dark:text-text-main">
                          Manhã
                        </button>
                        <button className="text-xs font-semibold px-3 py-1.5 rounded-full bg-background-light text-text-secondary hover:bg-border-light dark:bg-white/5 dark:text-gray-400 dark:hover:bg-white/10 transition-colors">
                          Tarde
                        </button>
                      </div>
                      {/* Slots Grid */}
                      <div className="grid grid-cols-3 sm:grid-cols-4 gap-3">
                        <button className="border border-border-light bg-surface-light dark:bg-surface-dark dark:border-white/10 hover:border-primary text-text-main dark:text-gray-200 py-2 rounded-lg text-sm font-medium transition-all">
                          08:00
                        </button>
                        <button className="border border-border-light bg-surface-light dark:bg-surface-dark dark:border-white/10 hover:border-primary text-text-main dark:text-gray-200 py-2 rounded-lg text-sm font-medium transition-all">
                          08:30
                        ...
                        {/* Disabled Slot */}
                        <button className="border border-transparent bg-gray-100 text-gray-400 dark:bg-white/5 dark:text-gray-600 py-2 rounded-lg text-sm font-medium cursor-not-allowed decoration-slice line-through opacity-60" disabled="">
                          10:30
                        </button>
                        <button className="border border-border-light bg-surface-light dark:bg-surface-dark dark:border-white/10 hover:border-primary text-text-main dark:text-gray-200 py-2 rounded-lg text-sm font-medium transition-all">
                          11:00
                      ...
                      <div className="mt-6 p-3 rounded-lg bg-yellow-50 dark:bg-yellow-900/10 border border-yellow-100 dark:border-yellow-900/30 flex items-start gap-3">
                        <span className="material-symbols-outlined text-yellow-600 dark:text-yellow-500 text-sm mt-0.5">
                          info
                        </span>
              ...
              <div className="lg:col-span-4 relative">
                <div className="sticky top-24 rounded-2xl border border-border-light bg-surface-light p-6 shadow-sm dark:bg-surface-dark dark:border-white/5">
                  <h3 className="text-lg font-bold text-text-main dark:text-white mb-6 border-b border-border-light dark:border-white/5 pb-4">
                  ...
                  <div className="mt-8 pt-4 border-t border-border-light dark:border-white/5">
                    ...
                    <p className="text-xs text-text-secondary dark:text-gray-500 text-right">
