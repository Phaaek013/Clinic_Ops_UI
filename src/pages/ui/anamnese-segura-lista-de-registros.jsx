...
export function AnamneseSeguraListaDeRegistros() {
  return (
    <div className="ui-page ui-anamnese-segura-lista-de-registros bg-background-light dark:bg-background-dark text-slate-800 dark:text-slate-200 font-display min-h-screen flex">
...
<span className="material-icons-round">dashboard</span> Painel Geral
        </a>
<a className="flex items-center gap-3 px-3 py-2 rounded-lg bg-primary/10 text-primary font-semibold" href="#">
<span className="material-icons-round">person</span> Pacientes
        </a>
<a className="flex items-center gap-3 px-3 py-2 rounded-lg text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors" href="#">
<span className="material-icons-round">calendar_today</span> Agendamentos
        </a>
<a className="flex items-center gap-3 px-3 py-2 rounded-lg text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors" href="#">
<span className="material-icons-round">settings</span> Configurações
        </a>
</nav>
<div className="p-4 border-t border-slate-200 dark:border-slate-800">
<div className="flex items-center gap-3">
<div className="w-8 h-8 rounded-full bg-slate-200 dark:bg-slate-700 overflow-hidden">
<img alt="Profile picture of a professional doctor" className="w-full h-full object-cover" src="/avatar.svg" />
</div>
<div className="flex-1 min-w-0">
<p className="text-xs font-bold truncate">Dr. Ricardo Silva</p>
<p className="text-[10px] text-slate-500 truncate uppercase tracking-wider">CRM/SP 123456</p>
</div>
</div>
</div>
</aside>
...
<span className="font-semibold">Perfil do Paciente</span>
</div>
<div className="flex items-center gap-4">
...
<div>
<div className="flex items-center gap-3">
<h1 className="text-2xl font-bold tracking-tight">Mariana Ferreira de Souza</h1>
<span className="px-2 py-0.5 bg-slate-100 dark:bg-slate-800 text-slate-500 text-[10px] font-bold rounded uppercase">ID: 88291-A</span>
</div>
<div className="flex gap-4 mt-1">
<div className="flex items-center gap-2 text-sm text-slate-500">
<span className="font-medium text-slate-400 uppercase text-[10px] tracking-widest">CPF:</span>
<span className="masked-data">445.***.***-09</span>
</div>
<div className="flex items-center gap-2 text-sm text-slate-500">
<span className="font-medium text-slate-400 uppercase text-[10px] tracking-widest">NASC:</span>
...
<p className="text-xs font-bold text-amber-800 dark:text-amber-500 uppercase tracking-wide">Dados Sensíveis</p>
<p className="text-[11px] text-amber-700 dark:text-amber-600/80">Todo acesso a esta ficha é auditado e registrado.</p>
</div>
</div>
</div>
<div className="flex gap-8">
<button className="pb-4 text-sm font-medium text-slate-500 hover:text-slate-800 dark:hover:text-slate-200 transition-colors">Cadastro</button>
<button className="pb-4 text-sm font-medium text-slate-500 hover:text-slate-800 dark:hover:text-slate-200 transition-colors">Agendamentos</button>
...
<button className="pb-4 text-sm font-medium text-slate-500 hover:text-slate-800 dark:hover:text-slate-200 transition-colors">Exames</button>
</div>
</div>
...
<span className="material-icons-round text-sm">add</span> Novo Registro
                        </button>
</div>
</div>
...
<div className="text-sm font-semibold">15 Set 2023</div>
<div className="text-[11px] text-slate-400">14:30h</div>
</td>
<td className="px-6 py-4">
<div className="flex items-center gap-2">
<span className="material-icons-round text-slate-300 text-sm">event</span>
<span className="text-xs font-medium">Agendamento #7721</span>
</div>
</td>
<td className="px-6 py-4">
<div className="text-xs font-medium">Dr. Ricardo Silva</div>
<div className="text-[10px] text-slate-400">Cardiologia</div>
</td>
<td className="px-6 py-4 text-center">
<span className="px-2.5 py-1 bg-emerald-100 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400 text-[10px] font-bold rounded-full uppercase tracking-wider">Finalizado</span>
</td>
...
<tr className="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors group">
<td className="px-6 py-4">
<div className="text-sm font-semibold">02 Set 2023</div>
<div className="text-[11px] text-slate-400">09:15h</div>
</td>
<td className="px-6 py-4">
<div className="flex items-center gap-2 text-slate-500">
<span className="material-icons-round text-slate-300 text-sm">description</span>
<span className="text-xs font-medium italic">Registro Avulso</span>
</div>
</td>
<td className="px-6 py-4">
<div className="text-xs font-medium">Dra. Amanda Costa</div>
<div className="text-[10px] text-slate-400">Nutrologia</div>
</td>
<td className="px-6 py-4 text-center">
<span className="px-2.5 py-1 bg-amber-100 dark:bg-amber-900/30 text-amber-600 dark:text-amber-500 text-[10px] font-bold rounded-full uppercase tracking-wider">Rascunho</span>
</td>
<td className="px-6 py-4 text-right">
<div className="flex items-center justify-end gap-1 opacity-60 group-hover:opacity-100 transition-opacity">
<button className="p-2 hover:bg-primary/10 hover:text-primary rounded-lg transition-colors" title="Abrir">
...
<h3 className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-4">Ações Operacionais</h3>
...
<a className="flex items-center gap-3 p-3 rounded-lg text-sm text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 border border-transparent hover:border-slate-200 dark:hover:border-slate-700 transition-all group" href="#">
<span className="material-icons-round text-slate-400 group-hover:text-primary">policy</span>
...
<h4 className="text-xs font-bold uppercase tracking-widest">Segurança de Dados</h4>
</div>
...
<div>
<h2 className="text-xl font-bold tracking-tight">Novo Registro de Anamnese</h2>
<p className="text-sm text-slate-500">Selecione como deseja iniciar este registro.</p>
<div className="flex items-center gap-1.5 mt-1">
<span className="material-icons-round text-[14px] text-slate-400">verified_user</span>
<span className="text-[11px] font-semibold text-slate-400 uppercase tracking-wider">Dados sensíveis — acesso restrito e auditado</span>
</div>
</div>
...
<span className="material-icons-round text-sm">link</span> Vincular
                </label>
...
<span className="material-icons-round text-sm">history_edu</span> Avulso
                </label>
</div>
<div className="space-y-4">
<div className="field-agendamento space-y-2">
<label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Selecionar Agendamento</label>
<div className="relative group">
<span className="material-icons-round absolute left-3 top-2.5 text-slate-400 text-sm">event</span>
...
<div className="space-y-2">
<label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Modelo de Anamnese</label>
<div className="relative">
<span className="material-icons-round absolute left-3 top-2.5 text-slate-400 text-sm">assignment</span>
...
<label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Motivo do registro avulso <span className="text-slate-400 font-normal lowercase">(opcional)</span></label>
<div className="relative">
<span className="material-symbols-outlined absolute left-3 top-2.5 text-slate-400 text-sm">edit_note</span>
...
<button className="px-6 py-2 text-sm font-bold text-slate-500 hover:text-slate-800 dark:hover:text-slate-200 transition-colors">Cancelar</button>
