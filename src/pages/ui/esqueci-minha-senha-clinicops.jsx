...
export function EsqueciMinhaSenhaClinicops() {
  return (
    <div className="ui-page ui-esqueci-minha-senha-clinicops bg-background-light dark:bg-background-dark min-h-screen flex items-center justify-center p-4">
