...
export function PreenchimentoDeAnamneseFormularioP02b() {
  return (
    <div className="ui-page ui-preenchimento-de-anamnese-formulario-p02b bg-background-light dark:bg-background-dark text-slate-800 dark:text-slate-100 min-h-screen flex flex-col font-display">
...
<li>Novo registro</li>
<li><span className="material-icons-round text-xs">chevron_right</span></li>
<li className="text-primary font-semibold">Formulário</li>
</ol>
</nav>
<div className="flex items-center gap-2">
<span className="px-2 py-0.5 bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 text-[10px] font-bold uppercase tracking-wider rounded">RASCUNHO</span>
</div>
</div>
<div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
<div className="flex items-center gap-3">
<h1 className="text-2xl font-extrabold tracking-tight text-slate-900 dark:text-white">Formulário — Anamnese Segura</h1>
</div>
...
<span className="material-icons-round text-sm">person</span> Paciente: Ricardo Silva | ID: 994.002.312-00
                    </span>
...
<span className="material-icons-round text-sm">event</span> Agendamento: 24 Out 2023 • 14:30 • Consulta Geral
                    </span>
<span className="flex items-center gap-1.5 px-3 py-1 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 rounded-full text-xs font-medium">
<span className="material-icons-round text-sm">description</span> Modelo: Anamnese Geral (V1)
                    </span>
</div>
</div>
...
<p className="font-medium text-xs sm:text-sm">Dados sensíveis — acesso controlado por perfil; registros de acesso podem ser gerados conforme política.</p>
</div>
</div>
</div>
</header>
...
<div className="absolute top-0 -ml-10 text-center mt-12 w-32 text-xs font-bold uppercase text-slate-500">Modelo</div>
</div>
...
<div className="absolute top-0 -ml-10 text-center mt-12 w-32 text-xs font-bold uppercase text-primary">Formulário</div>
</div>
</div>
</div>
...
<label className="text-sm font-semibold text-slate-700 dark:text-slate-300">Nome Social</label>
...
<div className="space-y-1.5">
<label className="text-sm font-semibold text-slate-700 dark:text-slate-300">Acompanhante <span className="text-red-500">*</span></label>
...
<p className="text-[11px] text-red-500 font-medium">Campo obrigatório</p>
</div>
</div>
</section>
...
<h2 className="text-lg font-bold">Queixa Principal</h2>
</div>
<div className="space-y-1.5">
<label className="text-sm font-semibold text-slate-700 dark:text-slate-300">Motivo da consulta</label>
<textarea className="w-full bg-slate-50 dark:bg-slate-800 border-slate-200 dark:border-slate-700 rounded-lg focus:ring-primary focus:border-primary text-sm" placeholder="Descreva sucintamente a queixa principal..." rows="3"></textarea>
</div>
</section>
...
<h2 className="text-lg font-bold">História da Doença Atual (HDA)</h2>
</div>
<div className="space-y-1.5">
<textarea className="w-full bg-slate-50 dark:bg-slate-800 border-slate-200 dark:border-slate-700 rounded-lg focus:ring-primary focus:border-primary text-sm" placeholder="Início, evolução, tratamentos prévios..." rows="5"></textarea>
</div>
</section>
...
<div className="flex items-center gap-2 mb-6 text-slate-900 dark:text-white border-b border-slate-100 dark:border-slate-800 pb-4">
<span className="material-icons-round text-primary">self_care</span>
...
<span className="text-sm font-medium text-slate-700 dark:text-slate-300">Tabagismo</span>
</label>
<label className="flex items-center gap-3 p-3 bg-slate-50 dark:bg-slate-800 rounded-lg cursor-pointer border border-transparent hover:border-primary/30 transition-colors">
<input className="rounded text-primary focus:ring-primary border-slate-300 dark:border-slate-600" type="checkbox" />
<span className="text-sm font-medium text-slate-700 dark:text-slate-300">Etilismo</span>
</label>
<label className="flex items-center gap-3 p-3 bg-slate-50 dark:bg-slate-800 rounded-lg cursor-pointer border border-transparent hover:border-primary/30 transition-colors">
<input className="rounded text-primary focus:ring-primary border-slate-300 dark:border-slate-600" type="checkbox" />
<span className="text-sm font-medium text-slate-700 dark:text-slate-300">Sedentarismo</span>
</label>
<label className="flex items-center gap-3 p-3 bg-slate-50 dark:bg-slate-800 rounded-lg cursor-pointer border border-transparent hover:border-primary/30 transition-colors">
<input className="rounded text-primary focus:ring-primary border-slate-300 dark:border-slate-600" type="checkbox" />
<span className="text-sm font-medium text-slate-700 dark:text-slate-300">Dieta</span>
</label>
</div>
</section>
...
<h2 className="text-lg font-bold">Alergias e Reações</h2>
</div>
<div className="space-y-4">
<div className="flex flex-wrap gap-2">
<span className="inline-flex items-center gap-1 px-3 py-1 bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400 rounded-full text-xs font-bold">DIPIRONA <button className="material-icons-round text-xs hover:text-red-900">close</button></span>
<span className="inline-flex items-center gap-1 px-3 py-1 bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400 rounded-full text-xs font-bold">PENICILINA <button className="material-icons-round text-xs hover:text-red-900">close</button></span>
</div>
...
<div className="flex items-center gap-2 mb-6 text-slate-900 dark:text-white border-b border-slate-100 dark:border-slate-800 pb-4">
<span className="material-icons-round text-primary">medication</span>
<h2 className="text-lg font-bold">Medicações em uso</h2>
</div>
<textarea className="w-full bg-slate-50 dark:bg-slate-800 border-slate-200 dark:border-slate-700 rounded-lg focus:ring-primary focus:border-primary text-sm" placeholder="Liste medicamentos, dosagem e frequência..." rows="3"></textarea>
</section>
...
<div className="flex items-center gap-2 mb-6 text-slate-900 dark:text-white border-b border-slate-100 dark:border-slate-800 pb-4">
<span className="material-icons-round text-primary">notes</span>
<h2 className="text-lg font-bold">Observações Complementares</h2>
</div>
<textarea className="w-full bg-slate-50 dark:bg-slate-800 border-slate-200 dark:border-slate-700 rounded-lg focus:ring-primary focus:border-primary text-sm" placeholder="Informações adicionais relevantes..." rows="3"></textarea>
</section>
</div>
...
<h3 className="font-bold text-sm text-slate-900 dark:text-white uppercase tracking-wider">Resumo do registro</h3>
</div>
...
<div>
<p className="font-bold text-slate-900 dark:text-white">Ricardo Silva</p>
<p className="text-xs text-slate-500">ID: 994.002.312-00</p>
</div>
</div>
...
<p className="text-sm font-semibold">42 anos</p>
</div>
<div className="p-2 rounded bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700">
<p className="text-[10px] text-slate-500 uppercase font-bold">Sexo</p>
<p className="text-sm font-semibold">Masculino</p>
</div>
</div>
</div>
<div className="pt-4 border-t border-slate-100 dark:border-slate-800 space-y-3">
<p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Profissional Responsável</p>
<div className="flex items-center gap-3">
<div className="w-8 h-8 rounded-full bg-primary/20 flex items-center justify-center text-primary">
<span className="material-icons-round text-sm">medical_services</span>
</div>
<div>
<p className="text-sm font-bold text-slate-900 dark:text-white">Dra. Ana Costa</p>
<p className="text-[11px] text-slate-500">CRM-SP 123.456</p>
</div>
</div>
</div>
<div className="pt-4 border-t border-slate-100 dark:border-slate-800">
<div className="flex items-center justify-between text-xs py-1">
<span className="text-slate-500">Última anamnese</span>
<span className="font-medium text-slate-700 dark:text-slate-300">12 Jan 2023</span>
</div>
</div>
</div>
</div>
<div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
<div className="p-4 bg-slate-50 dark:bg-slate-800/50 border-b border-slate-100 dark:border-slate-800">
<h3 className="font-bold text-sm text-slate-900 dark:text-white uppercase tracking-wider">Atalhos da Seção</h3>
</div>
...
<span className="material-icons-round text-lg">badge</span>
                            Identificação
                            <span className="ml-auto material-icons-round text-xs opacity-0 group-hover:opacity-100">arrow_forward</span>
</a>
...
<span className="material-icons-round text-lg">medical_information</span>
                            Queixa Principal
                        </a>
...
<span className="material-icons-round text-lg">self_care</span>
                            Hábitos
                        </a>
...
<span className="material-icons-round text-lg text-red-400">warning</span>
                            Alergias
                        </a>
...
<div>
<p className="text-xs font-bold text-slate-700 dark:text-slate-300 uppercase tracking-tight">Permissões</p>
<p className="text-[11px] text-slate-600 dark:text-slate-400 mt-1 leading-relaxed">Visibilidade restrita ao perfil assistencial e administrativo conforme política interna.</p>
</div>
</div>
</div>
</div>
...
<span className="text-xs font-medium italic">Rascunho salvo há 5s</span>
</div>
