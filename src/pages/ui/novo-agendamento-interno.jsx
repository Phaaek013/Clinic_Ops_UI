...
export function UiNovoAgendamentoInternoPage() {
  return (
    <section className="ui-stitch-screen" data-route="/ui/novo-agendamento-interno">
      <html className="light" lang="en">
        <head>
          <meta charset="utf-8" />
          <meta content="width=device-width, initial-scale=1.0" name="viewport" />
          <title>
            LifeMed ClinicOps - Novo Agendamento
          </title>
          {/* Google Fonts */}
        ...
        <body className="bg-background-light dark:bg-background-dark font-display text-text-dark antialiased overflow-hidden selection:bg-primary selection:text-text-dark">
              ...
              <div className="flex h-full flex-col justify-between p-4">
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex gap-3 items-center px-2">
                    <div className="bg-center bg-no-repeat aspect-square bg-cover rounded-full size-10 shadow-sm" data-alt="LifeMed Logo Abstract Gradient" style={{backgroundImage: "linear-gradient(135deg, #13ecec 0%, #0d1b1b 100%)"}}>
                    </div>
                    <div className="flex flex-col">
                      <h1 className="text-text-dark text-base font-bold leading-normal tracking-wide">
                        LifeMed
                      </h1>
                      <p className="text-text-light text-xs font-normal leading-normal tracking-wider">
                        CLINICOPS
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col gap-2 mt-4">
                    <div className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-background-light cursor-pointer transition-colors group">
                      <span className="material-symbols-outlined text-text-dark group-hover:text-primary-dark">
                        dashboard
                      </span>
                      <p className="text-text-dark text-sm font-medium leading-normal">
                        Painel
                      </p>
                    </div>
                    <div className="flex items-center gap-3 px-3 py-2 rounded-lg bg-primary/20 cursor-pointer">
                      <span className="material-symbols-outlined text-text-dark icon-fill">
                        calendar_today
                      </span>
                      <p className="text-text-dark text-sm font-bold leading-normal">
                        Agenda
                      </p>
                    </div>
                    <div className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-background-light cursor-pointer transition-colors group">
                ...
                <div className="border-t border-[#e7f3f3] pt-4">
                  <div className="flex items-center gap-3 px-2">
                    <div className="bg-center bg-no-repeat aspect-square bg-cover rounded-full size-8" data-alt="User Avatar Profile" style={{backgroundImage: "url(\"/placeholder.svg\")"}}>
                    </div>
                    <div className="flex flex-col">
                      <p className="text-text-dark text-sm font-medium leading-none">
                        Ana Souza
                      </p>
              ...
              <header className="flex-none flex items-center justify-between whitespace-nowrap border-b border-solid border-[#e7f3f3] bg-surface-light px-6 py-3 z-10">
                ...
                <div className="flex flex-1 justify-end gap-6 items-center">
                  ...
                  <button className="relative text-text-dark hover:text-primary-dark transition-colors">
                    ...
                    <span className="absolute top-0 right-0 size-2 bg-red-500 rounded-full border-2 border-surface-light">
                    </span>
                  </button>
                ...
                <div className="max-w-[1200px] mx-auto flex flex-col gap-6">
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-wrap gap-2 text-sm">
                      <a className="text-text-light hover:text-primary-dark transition-colors font-medium" href="#">
                        Home
                      </a>
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
                      <div className="flex flex-col gap-1">
                        <h2 className="text-text-dark text-3xl font-bold leading-tight tracking-tight">
                          Novo agendamento
                        </h2>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                    ...
                    <div className="lg:col-span-8 flex flex-col gap-6">
                        ...
                        <div className="p-6">
                          ...
                          <div className="flex items-center justify-between p-4 border border-primary/30 bg-[#f0fcfc] rounded-lg">
                            <div className="flex items-center gap-4">
                              <div className="size-12 rounded-full bg-cover bg-center border-2 border-white shadow-sm" data-alt="Portrait of Maria Silva" style={{backgroundImage: "url(\"/placeholder.svg\")"}}>
                              </div>
                              <div>
                      ...
                      <section className="bg-surface-light rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <div className="p-6 flex flex-col gap-6">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="flex flex-col gap-2">
                              <label className="text-sm font-semibold text-text-dark flex justify-between">
                                ...
                                <span className="text-xs font-medium text-primary-dark bg-primary/10 px-2 py-0.5 rounded-full">
                                  30 min
                                </span>
                              </label>
                              <div className="relative">
                                ...
                                <span className="material-symbols-outlined absolute right-3 top-1/2 -translate-y-1/2 text-text-light pointer-events-none">
                                  expand_more
                                </span>
                              </div>
                            </div>
                            <div className="flex flex-col gap-2">
                              ...
                              <div className="relative">
                                ...
                                <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-text-light pointer-events-none text-[20px]">
                                  stethoscope
                                </span>
                                <span className="material-symbols-outlined absolute right-3 top-1/2 -translate-y-1/2 text-text-light pointer-events-none">
                                  expand_more
                          ...
                          <div className="grid grid-cols-1 gap-4">
                            <div className="flex items-start gap-3 p-3 bg-blue-50/50 rounded-lg border border-blue-100">
                              ...
                              <div className="text-sm leading-6">
                                <label className="font-medium text-text-dark" htmlFor="waiting-list">
                                  Lista de espera prioritária
                                </label>
                                <p className="text-text-light text-xs">
                                  Marque se o paciente deseja ser notificado caso surja uma vaga anterior a esta data.
                                </p>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="flex flex-col gap-2">
                            ...
                            <textarea className="w-full p-4 bg-background-light border border-gray-200 rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary text-sm resize-none" placeholder="Ex: Paciente precisa de acessibilidade, preferência por sala térrea..." rows="3">
                            </textarea>
                          </div>
                        </div>
                      </section>
                      ...
                      <div className="flex items-center justify-between pt-2">
                        <a className="text-text-light text-sm font-medium hover:text-text-dark hover:underline" href="#">
                        ...
                        <div className="bg-surface-light rounded-xl shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-gray-100 overflow-hidden">
                          ...
                          <div className="p-5 flex flex-col gap-5">
                            ...
                            <div className="flex flex-col gap-1">
                              ...
                              <div className="flex items-center gap-3">
                                <div className="size-8 rounded-full bg-cover bg-center" data-alt="Small avatar of Maria Silva" style={{backgroundImage: "url(\"/placeholder.svg\")"}}>
                                </div>
                            ...
                            <div className="mt-2 p-3 bg-emerald-50 border border-emerald-100 rounded-lg flex items-start gap-3">
                              ...
                              <div>
                                ...
                                <p className="text-emerald-600 text-xs mt-0.5">
                                  Nenhum conflito encontrado na agenda do Dr. Roberto.
                                </p>
                              </div>
                            </div>
                            {/* Example of Conflict State (Hidden but present in code for reference) */}
                            {/* <div class="mt-2 p-3 bg-amber-50 border border-amber-100 rounded-lg flex items-start gap-3"> <div class="text-amber-500 mt-0.5"> <span class="material-symbols-outlined icon-fill text-[20px]">warning</span> </div> <div> <p class="text-amber-800 text-sm font-bold">Conflito de Horário</p> <p class="text-amber-600 text-xs mt-0.5">Dr. Roberto já possui agendamento.</p> <button class="mt-2 text-xs font-bold text-amber-700 underline">Sugerir 14:30</button> </div> </div> */}
                          </div>
                        ...
                        <div className="bg-blue-50/50 border border-blue-100 rounded-lg p-4">
                          <div className="flex gap-2 items-start">
                            ...
                            <p className="text-xs text-blue-800 leading-relaxed">
                              ...
                              Utilize o atalho
                              <kbd className="px-1.5 py-0.5 rounded bg-white border border-blue-200 text-[10px] font-mono mx-1">
                                Alt + N
                              </kbd>
                              para iniciar um novo cadastro rápido de paciente sem sair desta tela.
                            </p>
                          </div>
                        </div>
                      </div>
