...
export function AnexosDoRegistroDeAnamneseP03c() {
  return (
    <div className="ui-page ui-anexos-do-registro-de-anamnese-p03c bg-background-light dark:bg-background-dark font-display text-slate-800 dark:text-slate-200 min-h-screen flex flex-col">
...
<h3 className="text-lg font-bold">Confirmar Remoção</h3>
</div>
<p className="text-sm text-slate-600 dark:text-slate-400 mb-4 leading-relaxed">
                Você está prestes a remover o arquivo <span className="font-bold text-slate-900 dark:text-white">laudo_cardiologico_v1.pdf</span>. Esta ação é irreversível.
            </p>
<div className="mb-4">
<label className="block text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-1.5">Motivo da remoção</label>
<textarea className="w-full bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-lg text-sm p-3 focus:ring-primary focus:border-primary" placeholder="Descreva brevemente o motivo..." rows="3"></textarea>
</div>
...
<span className="material-icons-round text-amber-500 text-sm">history_edu</span>
<span className="text-[11px] text-amber-700 dark:text-amber-400 font-medium italic">Esta ação será registrada em auditoria</span>
</div>
<div className="flex items-center justify-end gap-3">
<button className="px-4 py-2 text-sm font-semibold text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg transition-all" onclick="document.getElementById('modal-remover').classList.add('hidden')">Cancelar</button>
<button className="px-6 py-2 text-sm font-bold bg-red-500 text-white rounded-lg shadow-lg shadow-red-500/20 hover:bg-red-600 transition-all">Remover Arquivo</button>
</div>
</div>
</div>
</div>
...
<span className="hover:text-primary cursor-pointer">Anamnese Segura</span>
<span className="material-icons-round text-[14px]">chevron_right</span>
<span className="text-slate-800 dark:text-slate-100">Registro #AG-4022</span>
</nav>
<div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
<div className="flex items-center gap-4">
<h1 className="text-2xl font-extrabold text-slate-900 dark:text-white tracking-tight">Registro de Anamnese Segura</h1>
...
<button className="pb-4 text-sm font-medium text-slate-500 hover:text-slate-800 dark:hover:text-slate-200 transition-colors">Resumo</button>
<button className="pb-4 text-sm font-medium text-slate-500 hover:text-slate-800 dark:hover:text-slate-200 transition-colors">Formulário</button>
<button className="pb-4 text-sm font-bold text-slate-900 dark:text-primary border-b-2 border-primary relative flex items-center gap-2">
            Anexos
            <span className="bg-primary/20 text-slate-800 dark:text-primary px-2 py-0.5 rounded-full text-[10px]">2</span>
</button>
<button className="pb-4 text-sm font-medium text-slate-500 hover:text-slate-800 dark:hover:text-slate-200 transition-colors">Histórico &amp; Auditoria</button>
<button className="pb-4 text-sm font-medium text-slate-500 hover:text-slate-800 dark:hover:text-slate-200 transition-colors">Exportar / Imprimir</button>
</div>
...
<h3 className="text-sm font-bold text-slate-900 dark:text-white uppercase tracking-wider">Gerenciar Arquivos</h3>
...
<p className="text-sm font-semibold text-slate-700 dark:text-slate-300 mb-1">Arraste documentos ou clique para buscar</p>
<p className="text-xs text-slate-400">Seleção múltipla disponível para envio seguro</p>
...
<th className="px-6 py-4">Arquivo / Permissão</th>
<th className="px-6 py-4">Tipo/Tamanho</th>
...
<div className="flex items-center gap-3">
<span className="material-icons-round text-primary animate-pulse">insert_drive_file</span>
<div>
<div className="text-sm font-bold text-slate-800 dark:text-slate-200">exame_sangue_ag4022.pdf</div>
<div className="flex items-center gap-1 text-[9px] font-bold text-slate-400 uppercase mt-0.5">
<span className="material-icons-round text-[11px]">lock</span> Restrito
                                            </div>
<div className="w-48 h-1 bg-slate-200 dark:bg-slate-700 rounded-full mt-2 overflow-hidden">
<div className="bg-primary h-full rounded-full" style={{width: '65%'}}></div>
</div>
<span className="text-[10px] text-primary font-bold mt-1 inline-block uppercase tracking-wider">Enviando 65%...</span>
</div>
</div>
</td>
<td className="px-6 py-4">
<div className="text-[11px] font-medium text-slate-500 uppercase tracking-tighter">PDF / 2.4 MB</div>
</td>
<td className="px-6 py-4">
<div className="text-[11px] font-medium text-slate-500 uppercase tracking-tighter">15/10/2023 - 14:22</div>
</td>
<td className="px-6 py-4">
<div className="text-xs font-semibold text-slate-600 dark:text-slate-400 flex items-center gap-1">
<div className="w-5 h-5 bg-slate-200 dark:bg-slate-700 rounded-full flex items-center justify-center text-[8px] font-bold">DR</div>
                                        Dra. Rita Mendes
                                    </div>
</td>
<td className="px-6 py-4">
<span className="px-2 py-0.5 bg-slate-100 dark:bg-slate-800 text-slate-400 text-[9px] font-bold uppercase rounded border border-slate-200 dark:border-slate-700">Aguardando...</span>
</td>
...
<div>
<div className="text-sm font-bold text-slate-800 dark:text-slate-200">laudo_cardiologico_v1.pdf</div>
<div className="flex items-center gap-1 text-[9px] font-bold text-slate-400 uppercase mt-0.5">
<span className="material-icons-round text-[11px]">group</span> Equipe
                                            </div>
</div>
</div>
</td>
<td className="px-6 py-4">
<div className="text-[11px] font-medium text-slate-500 uppercase tracking-tighter">PDF / 1.1 MB</div>
</td>
<td className="px-6 py-4">
<div className="text-[11px] font-medium text-slate-500 uppercase tracking-tighter">15/10/2023 - 13:45</div>
</td>
<td className="px-6 py-4">
<div className="text-xs font-semibold text-slate-600 dark:text-slate-400 flex items-center gap-1">
<div className="w-5 h-5 bg-primary/20 text-primary rounded-full flex items-center justify-center text-[8px] font-bold">DR</div>
                                        Dra. Rita Mendes
                                    </div>
</td>
<td className="px-6 py-4">
<div className="flex gap-1 flex-wrap">
<span className="px-2 py-0.5 bg-primary/10 text-primary text-[9px] font-bold uppercase rounded border border-primary/10">EXAME</span>
<span className="px-2 py-0.5 bg-slate-100 dark:bg-slate-800 text-slate-500 text-[9px] font-bold uppercase rounded border border-slate-200 dark:border-slate-700">URGENTE</span>
</div>
</td>
...
<button className="w-full flex items-center gap-2 px-4 py-2 text-left text-xs font-semibold text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
<span className="material-icons-round text-sm">edit</span> Renomear
                                                </button>
<button className="w-full flex items-center gap-2 px-4 py-2 text-left text-xs font-semibold text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
<span className="material-icons-round text-sm">label</span> Editar tags
                                                </button>
...
<span className="material-icons-round text-sm">delete</span> Remover
                                                </button>
</div>
</div>
</div>
...
<div>
<div className="text-sm font-bold text-slate-800 dark:text-slate-200">receita_medicamentos_ref.jpg</div>
<div className="flex items-center gap-1 text-[9px] font-bold text-slate-400 uppercase mt-0.5">
<span className="material-icons-round text-[11px]">apartment</span> Clínica
                                            </div>
</div>
</div>
</td>
<td className="px-6 py-4">
<div className="text-[11px] font-medium text-slate-500 uppercase tracking-tighter">JPG / 842 KB</div>
</td>
<td className="px-6 py-4">
<div className="text-[11px] font-medium text-slate-500 uppercase tracking-tighter">14/10/2023 - 10:15</div>
</td>
<td className="px-6 py-4">
<div className="text-xs font-semibold text-slate-600 dark:text-slate-400 flex items-center gap-1">
<div className="w-5 h-5 bg-primary/20 text-primary rounded-full flex items-center justify-center text-[8px] font-bold">DR</div>
...
<td className="px-6 py-4">
<div className="flex gap-1 flex-wrap">
<span className="px-2 py-0.5 bg-slate-100 dark:bg-slate-800 text-slate-500 text-[9px] font-bold uppercase rounded border border-slate-200 dark:border-slate-700">RECEITA</span>
</div>
</td>
<td className="px-6 py-4 text-right relative">
<div className="flex items-center justify-end gap-1">
...
<div className="flex items-center justify-between mb-4">
<h3 className="text-sm font-bold text-slate-900 dark:text-white uppercase tracking-wider">Preview do Anexo</h3>
<span className="material-icons-round text-slate-400 text-[18px] cursor-not-allowed">fullscreen</span>
</div>
...
<span className="material-icons-round text-3xl">pageview</span>
</div>
<p className="text-sm font-bold text-slate-400 dark:text-slate-600 uppercase tracking-widest leading-tight">Selecione um anexo para visualizar</p>
<p className="text-[10px] text-slate-400 mt-2 max-w-[180px]">Clique no ícone de visualização na lista para abrir o documento aqui.</p>
</div>
</div>
...
<span className="material-icons-round text-6xl text-white dark:text-primary">security</span>
</div>
<div className="relative z-10">
<div className="flex items-center gap-2 mb-3 text-primary">
<span className="material-icons-round text-[20px]">lock</span>
<h4 className="text-sm font-bold uppercase tracking-widest">Permissões &amp; Segurança</h4>
</div>
...
<div className="bg-white dark:bg-background-dark/50 border border-slate-200 dark:border-slate-800 rounded-xl p-6 shadow-sm">
<h3 className="text-sm font-bold text-slate-900 dark:text-white uppercase tracking-wider mb-4">Atalhos</h3>
...
<span className="text-xs font-semibold text-slate-700 dark:text-slate-300">Ver registro de auditoria</span>
<span className="material-icons-round text-slate-400 text-[18px]">open_in_new</span>
</button>
<button className="w-full flex items-center justify-between p-3 rounded-lg bg-slate-50 dark:bg-slate-900/50 border border-slate-100 dark:border-slate-800 hover:border-primary/40 hover:bg-white dark:hover:bg-slate-800 transition-all text-left">
<span className="text-xs font-semibold text-slate-700 dark:text-slate-300">Exportar todos os anexos (.zip)</span>
<span className="material-icons-round text-slate-400 text-[18px]">archive</span>
</button>
<button className="w-full flex items-center justify-between p-3 rounded-lg bg-slate-50 dark:bg-slate-900/50 border border-slate-100 dark:border-slate-800 hover:border-primary/40 hover:bg-white dark:hover:bg-slate-800 transition-all text-left">
<span className="text-xs font-semibold text-slate-700 dark:text-slate-300">Relatório de integridade</span>
<span className="material-icons-round text-slate-400 text-[18px]">verified_user</span>
</button>
</div>
</div>
</div>
