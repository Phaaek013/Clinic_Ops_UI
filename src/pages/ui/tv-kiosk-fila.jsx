...
export function TvKioskFila() {
  return (
    <div className="ui-page ui-tv-kiosk-fila bg-background-light dark:bg-background-dark text-text-main dark:text-white h-screen w-screen overflow-hidden flex flex-col selection:bg-primary selection:text-text-main">
{/*Minimalist Header*/}
...
<span className="material-symbols-outlined font-bold">local_hospital</span>
</div>
<h1 className="text-xl font-bold tracking-tight text-text-main dark:text-white">LifeMed <span className="font-normal opacity-70">ClinicOps</span></h1>
</div>
{/*Vertical Divider*/}
<div className="h-6 w-px bg-gray-300 dark:bg-gray-700 mx-2"></div>
{/*Screen Title*/}
<span className="text-lg font-semibold tracking-wide uppercase text-text-muted dark:text-primary/80">Fila de Atendimento</span>
</div>
{/*System Info Area*/}
...
<span className="text-lg font-bold tabular-nums text-text-main dark:text-gray-100">14:35</span>
<span className="text-sm font-medium text-text-muted opacity-80 border-l border-gray-300 dark:border-gray-600 pl-2 ml-1">24 Out</span>
</div>
{/*Status Indicator*/}
...
<div className="absolute -top-[20%] -left-[10%] w-[60%] h-[60%] rounded-full bg-primary/10 blur-[100px]"></div>
<div className="absolute top-[40%] right-[10%] w-[40%] h-[40%] rounded-full bg-blue-400/10 blur-[80px]"></div>
</div>
{/*Content Container*/}
...
<span className="animate-ping inline-flex h-full w-full rounded-full bg-red-500 opacity-75"></span>
</span>
<h2 className="text-xl font-bold tracking-[0.2em] text-red-600 dark:text-red-400 uppercase">Chamando Agora</h2>
</div>
...
{/*Huge Ticket Number*/}
<span className="text-[12rem] md:text-[14rem] leading-[0.85] font-black text-text-main dark:text-white tracking-tighter mb-6 selection:bg-primary/30">A-102</span>
<div className="h-px w-32 bg-gray-200 dark:bg-gray-600 mb-8"></div>
{/*Destination*/}
<h3 className="text-5xl md:text-6xl font-bold text-text-main dark:text-gray-100 tracking-tight">Consultório 05</h3>
{/*Optional Patient Initials (Privacy Friendly)*/}
<p className="mt-6 text-2xl font-medium text-text-muted dark:text-gray-400">Paciente: M. S. A.</p>
</div>
</div>
{/*Action Badge*/}
...
<span className="material-symbols-outlined text-4xl font-bold">directions_walk</span>
<span className="text-3xl font-black tracking-wide uppercase">Dirija-se à sala</span>
</div>
</div>
</section>
...
<span className="p-2 bg-primary/20 rounded-lg text-primary material-symbols-outlined">format_list_bulleted</span>
                    PRÓXIMOS
                </h2>
<div className="flex items-center gap-2">
<span className="text-sm font-semibold text-text-muted bg-gray-200 dark:bg-gray-800 px-3 py-1 rounded-full">5 na fila</span>
</div>
</div>
...
<span className="text-4xl font-bold text-text-main dark:text-white tracking-tight">A-103</span>
<span className="text-xs font-bold text-text-muted mt-1 uppercase tracking-wider">Aguardando</span>
</div>
<div className="flex flex-col items-end text-right">
<span className="text-xl font-bold text-gray-700 dark:text-gray-200">Triagem</span>
<span className="text-sm text-gray-400 dark:text-gray-500 font-medium">Sala 02</span>
</div>
</div>
...
<span className="text-4xl font-bold text-text-main dark:text-white flex items-center gap-2 tracking-tight">
                            P-005
                            <span className="material-symbols-outlined text-amber-500 text-3xl" title="Preferencial">accessible</span>
</span>
<span className="text-xs font-bold text-amber-600 dark:text-amber-500 mt-1 uppercase tracking-wider">Preferencial</span>
</div>
<div className="flex flex-col items-end text-right">
<span className="text-xl font-bold text-gray-700 dark:text-gray-200">Recepção</span>
<span className="text-sm text-gray-400 dark:text-gray-500 font-medium">Balcão 1</span>
</div>
</div>
{/*Queue Item 3*/}
...
<div className="flex flex-col">
<span className="text-4xl font-bold text-text-main dark:text-white tracking-tight">A-104</span>
<span className="text-xs font-bold text-text-muted mt-1 uppercase tracking-wider">Aguardando</span>
</div>
<div className="flex flex-col items-end text-right">
<span className="text-xl font-bold text-gray-700 dark:text-gray-200">Consultório 02</span>
<span className="text-sm text-gray-400 dark:text-gray-500 font-medium">Sala 02</span>
</div>
</div>
{/*Queue Item 4*/}
...
<div className="flex flex-col">
<span className="text-4xl font-bold text-text-main dark:text-white tracking-tight">B-012</span>
</div>
<div className="flex flex-col items-end text-right">
<span className="text-xl font-bold text-gray-700 dark:text-gray-200">Raio-X</span>
</div>
</div>
{/*Queue Item 5*/}
...
<div className="flex flex-col">
<span className="text-4xl font-bold text-text-main dark:text-white tracking-tight">A-105</span>
</div>
<div className="flex flex-col items-end text-right">
<span className="text-xl font-bold text-gray-700 dark:text-gray-200">Triagem</span>
</div>
...
<div className="absolute bottom-0 left-0 w-full h-24 bg-gradient-to-t from-background-light dark:from-[#0c1a1a] to-transparent pointer-events-none z-10"></div>
</section>
</main>
{/*Info/Ticker Footer*/}
...
<p className="text-base font-bold text-text-main dark:text-white leading-tight">Acompanhe pelo celular</p>
<p className="text-sm text-text-muted font-medium">lifemed.com/painel</p>
</div>
<div className="h-14 w-14 bg-white p-1 rounded-lg shadow-sm border border-gray-200 flex-shrink-0">
<img alt="QR Code for mobile tracking" className="w-full h-full object-contain mix-blend-multiply" data-alt="QR Code linking to patient mobile panel" src="/avatar.svg" />
</div>
</div>
</div>
</footer>
