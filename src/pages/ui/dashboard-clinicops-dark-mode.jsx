...
export function UiDashboardClinicopsDarkModePage() {
  return (
    <section className="ui-stitch-screen" data-route="/ui/dashboard-clinicops-dark-mode">
      <html className="dark" lang="en">
        <head>
          <meta charset="utf-8" />
          <meta content="width=device-width, initial-scale=1.0" name="viewport" />
          <title>
            ClinicOps - Internal Dashboard
          </title>
        ...
        <body className="bg-background-light dark:bg-background-dark text-slate-900 dark:text-slate-100 min-h-screen flex overflow-hidden">
          {/* Sidebar */}
            ...
            <div className="p-4 border-t border-slate-200 dark:border-slate-800">
              <div className="flex items-center gap-3 bg-slate-100 dark:bg-slate-800/50 p-3 rounded-xl">
                <div className="size-10 rounded-full bg-slate-300 dark:bg-slate-700 overflow-hidden">
                  <img className="w-full h-full object-cover" data-alt="User profile avatar with professional look" src="/placeholder.svg" />
                </div>
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-semibold truncate">
                    Dr. Helena Smith
                  </p>
                  <span className="inline-flex px-2 py-0.5 rounded-full bg-primary/20 text-primary text-[10px] font-bold uppercase tracking-wider">
                    Admin
                  </span>
                </div>
              </div>
          ...
          <div className="flex-1 flex flex-col h-screen overflow-hidden">
            ...
            <header className="h-16 border-b border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-[#111817]/80 backdrop-blur-md flex items-center justify-between px-8 z-10">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="size-px h-6 bg-slate-300 dark:bg-slate-700 mx-1">
                </div>
                <button className="p-2 text-slate-500 hover:text-primary relative">
                  <span className="material-symbols-outlined">
                    notifications
                  </span>
                  <span className="absolute top-2 right-2 size-2 bg-red-500 rounded-full border-2 border-white dark:border-[#111817]">
                  </span>
                </button>
                    ...
                    <table className="w-full">
                      ...
                      <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                        ...
                        <tr className="hover:bg-slate-50/50 dark:hover:bg-slate-800/30 transition-colors">
                          ...
                          <td className="px-6 py-4">
                            <span className="px-2.5 py-1 rounded-full text-xs font-bold bg-blue-500/10 text-blue-500">
                              Waiting
                            </span>
                          </td>
                        </tr>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="bg-white dark:bg-[#1c2725] rounded-xl border border-slate-200 dark:border-slate-800">
                  <div className="p-5 border-b border-slate-200 dark:border-slate-800 flex justify-between items-center">
                    ...
                    <span className="bg-orange-500/10 text-orange-500 px-2 py-0.5 rounded text-[10px] font-bold">
                      12 NOVOS
                    </span>
                  </div>
                  <div className="p-4 space-y-4">
                    <div className="flex items-center justify-between group">
                      <div className="flex items-center gap-3">
                        <div className="size-10 bg-slate-100 dark:bg-slate-800 rounded-lg flex items-center justify-center font-bold text-slate-500">
                          FM
                        </div>
                        <div>
