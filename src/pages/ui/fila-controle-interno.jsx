...
export function UiFilaControleInternoPage() {
  return (
    <section className="ui-stitch-screen" data-route="/ui/fila-controle-interno">
      <html className="light" lang="pt-BR">
        <head>
          <meta charset="utf-8" />
          <meta content="width=device-width, initial-scale=1.0" name="viewport" />
          <title>
            LifeMed - Controle de Fila
          </title>
          {/* Fonts */}
        ...
        <body className="bg-background-light dark:bg-background-dark text-text-main font-display h-screen flex overflow-hidden selection:bg-primary/30">
          {/* Sidebar */}
          <aside className="hidden md:flex flex-col w-72 bg-surface-light dark:bg-surface-dark border-r border-border-color h-full flex-shrink-0 z-20 transition-all duration-300">
            <div className="p-6 pb-2">
              <div className="flex items-center gap-3">
                <div className="bg-center bg-no-repeat bg-cover rounded-full h-10 w-10 shrink-0 shadow-sm ring-2 ring-primary/20" data-alt="Abstract medical cross logo with teal gradient" style={{backgroundImage: "url(\"/placeholder.svg\")"}}>
                </div>
                <div className="flex flex-col overflow-hidden">
                  <h1 className="text-text-main text-base font-bold leading-none truncate">
                    LifeMed
                  </h1>
                  <p className="text-text-secondary text-xs font-medium leading-normal mt-1 truncate">
                    ClinicOps System
                  </p>
                </div>
              </div>
            ...
            <div className="flex-1 overflow-y-auto px-4 py-4 flex flex-col gap-1">
              <nav className="flex flex-col gap-1">
                <a className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-text-main/70 hover:bg-primary-light hover:text-text-main transition-colors group" href="#">
                  <span className="material-symbols-outlined text-[24px] group-hover:text-primary-dark transition-colors">
                    dashboard
                  </span>
                ...
                <a className="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-primary/10 text-primary-dark font-semibold shadow-sm ring-1 ring-primary/20" href="#">
                  <span className="material-symbols-outlined text-[24px] text-primary-dark fill-current">
            ...
            <div className="p-4 border-t border-border-color">
              <div className="flex items-center gap-3 px-3 py-2 rounded-lg bg-background-light dark:bg-background-dark border border-border-color cursor-pointer hover:border-primary/50 transition-colors">
                <div className="bg-center bg-no-repeat bg-cover rounded-full h-8 w-8" data-alt="User avatar profile picture showing a smiling professional" style={{backgroundImage: "url(\"/placeholder.svg\")"}}>
                </div>
              ...
              <div className="flex-1 flex items-center gap-4 max-w-xl">
                <div className="relative w-full group">
                  ...
                  <div className="absolute inset-y-0 right-0 flex items-center pr-2 pointer-events-none">
                    <kbd className="inline-flex items-center border border-border-color rounded px-1.5 text-[10px] font-medium text-text-secondary bg-white dark:bg-surface-dark">
                      ⌘K
                    </kbd>
                  </div>
                </div>
              ...
              <div className="max-w-[1400px] mx-auto flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex items-center gap-2 text-sm">
                    <a className="text-text-secondary hover:text-primary-dark transition-colors" href="#">
                      Dashboard
                    </a>
                  ...
                  <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                    <div>
                      ...
                      <p className="text-text-secondary mt-1">
                        Gerencie chamadas e o fluxo da recepção em tempo real.
                      </p>
                    </div>
                    <div className="flex items-center gap-2 px-3 py-1.5 bg-yellow-50 dark:bg-yellow-900/10 border border-yellow-200 dark:border-yellow-900/30 rounded-full">
                      <span className="material-symbols-outlined text-yellow-600 dark:text-yellow-500 text-[18px]">
                        visibility_off
                      </span>
                      <span className="text-xs font-medium text-yellow-700 dark:text-yellow-500">
                        Nomes são abreviados na TV
                      </span>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="xl:col-span-8 flex flex-col gap-6">
                    ...
                    <div className="bg-surface-light dark:bg-surface-dark rounded-xl shadow-sm border border-primary/30 relative overflow-hidden group">
                      ...
                      <div className="flex justify-between items-center px-6 py-4 border-b border-border-color bg-background-light/30">
                        <h3 className="text-lg font-bold text-text-main flex items-center gap-2">
                          <span className="material-symbols-outlined text-primary-dark animate-pulse">
                            campaign
                          </span>
                          Chamando agora
                        </h3>
                      ...
                      <div className="p-6 md:p-8 flex flex-col md:flex-row gap-8 items-center md:items-stretch">
                        ...
                        <div className="flex flex-col items-center justify-center p-6 bg-background-light dark:bg-background-dark rounded-xl border border-border-color min-w-[200px] text-center shadow-inner">
                          <span className="text-sm font-semibold text-text-secondary uppercase tracking-widest mb-1">
                            Senha Atual
                          </span>
                          <span className="text-6xl md:text-7xl font-extrabold text-text-main tracking-tighter tabular-nums">
                            A042
                          </span>
                          <span className="text-xs font-medium text-text-secondary mt-2 bg-white dark:bg-surface-light px-2 py-1 rounded border border-border-color">
                            Preferencial
                          </span>
                        </div>
                        {/* Details & Controls */}
                        <div className="flex-1 flex flex-col justify-between w-full gap-6">
                          <div className="grid grid-cols-2 gap-4">
                            <div className="flex flex-col gap-1">
                              ...
                              <span className="text-lg font-bold text-text-main truncate">
                                Roberto Silva Jr.
                              </span>
                          ...
                          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-auto">
                            ...
                            <button className="col-span-2 md:col-span-1 py-2.5 px-4 rounded-lg border border-border-color text-text-secondary hover:text-red-600 hover:border-red-200 hover:bg-red-50 transition-colors flex items-center justify-center gap-2 group/btn">
                              <span className="material-symbols-outlined text-[20px] group-hover/btn:text-red-600">
                                cancel
                              </span>
                    ...
                    <div className="bg-surface-light dark:bg-surface-dark rounded-xl shadow-sm border border-border-color flex flex-col flex-1">
                        ...
                        <table className="w-full text-left border-collapse">
                          ...
                          <tbody className="text-sm divide-y divide-border-color">
                            ...
                            <tr className="hover:bg-background-light dark:hover:bg-surface-dark/80 transition-colors group">
                              <td className="px-6 py-4 font-bold text-text-main tabular-nums">
                                A043
                              </td>
                              ...
                              <td className="px-6 py-4 text-text-secondary tabular-nums hidden sm:table-cell">
                                10:15
                              </td>
                      ...
                      <div className="px-6 py-4 border-t border-border-color flex items-center justify-between text-sm text-text-secondary bg-background-light/30">
                        ...
                        <div className="flex gap-2">
                          <button className="px-3 py-1 rounded border border-border-color hover:bg-white disabled:opacity-50">
                            Anterior
                          </button>
                          <button className="px-3 py-1 rounded border border-border-color hover:bg-white disabled:opacity-50">
                            Próximo
                      ...
                      <div className="p-5 flex flex-col gap-4">
                        ...
                        <div className="pt-2">
                          ...
                          <select className="w-full bg-background-light dark:bg-background-dark border border-border-color rounded-lg text-sm py-2 px-3 focus:ring-primary focus:border-primary">
                            <option>
                              Nome da Sala e Número
                            </option>
                            <option>
                              Apenas Número da Sala
                            </option>
                            <option>
                              Não exibir destino
                            </option>
