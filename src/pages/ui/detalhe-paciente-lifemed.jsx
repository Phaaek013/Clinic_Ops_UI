...
export function UiDetalhePacienteLifemedPage() {
  return (
    <section className="ui-stitch-screen" data-route="/ui/detalhe-paciente-lifemed">
      <html className="light" lang="pt-BR">
        <head>
          <meta charset="utf-8" />
          <meta content="width=device-width, initial-scale=1.0" name="viewport" />
          <title>
            Detalhe Paciente - LifeMed ClinicOps
          </title>
          {/* Fonts */}
        ...
        <body className="bg-background-light dark:bg-background-dark text-text-main font-display antialiased overflow-hidden selection:bg-primary/30">
              ...
              <div className="p-6 flex flex-col h-full justify-between">
                <div className="flex flex-col gap-8">
                  ...
                  <div className="flex gap-3 items-center">
                    <div className="bg-center bg-no-repeat bg-cover rounded-full size-10 shadow-sm" data-alt="LifeMed Logo Abstract Gradient" style={{backgroundImage: "url(\"/placeholder.svg\")"}}>
                    </div>
                    <div className="flex flex-col">
                      <h1 className="text-text-main text-lg font-bold leading-none">
                        LifeMed
                      </h1>
                  ...
                  <nav className="flex flex-col gap-2">
                    <a className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-text-main hover:bg-border-light transition-colors group" href="#">
                      <span className="material-symbols-outlined text-text-secondary group-hover:text-text-main transition-colors">
                        dashboard
                      </span>
                ...
                <div className="flex items-center gap-3 px-3 py-3 rounded-xl bg-white border border-border-light shadow-sm cursor-pointer hover:shadow-md transition-shadow">
                  <div className="bg-center bg-no-repeat bg-cover rounded-full size-8" data-alt="User Avatar" style={{backgroundImage: "url(\"/placeholder.svg\")"}}>
                  </div>
            ...
            <div className="flex-1 flex flex-col min-w-0 h-full bg-white relative">
              ...
              <header className="h-16 border-b border-border-light flex items-center justify-between px-6 lg:px-8 bg-background-light/50 backdrop-blur-sm sticky top-0 z-30">
                ...
                <div className="hidden md:flex max-w-md w-full ml-4">
                  <div className="relative w-full group">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                      <span className="material-symbols-outlined text-text-secondary group-focus-within:text-primary-dark transition-colors">
                        search
                      </span>
                    </div>
                ...
                <div className="flex items-center gap-4 ml-auto">
                  ...
                  {/* Mobile Avatar */}
                  <div className="lg:hidden bg-center bg-no-repeat bg-cover rounded-full size-8 ml-2" data-alt="User Avatar Mobile" style={{backgroundImage: "url(\"/placeholder.svg\")"}}>
                  </div>
                </div>
              </header>
              ...
              <main className="flex-1 overflow-y-auto bg-[#f8fcfc] p-4 md:p-8">
                <div className="max-w-7xl mx-auto space-y-6">
                  ...
                  <div className="bg-white rounded-2xl shadow-sm border border-border-light p-6 md:p-8 relative overflow-hidden group">
                    {/* Background Pattern */}
                    <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-bl from-primary/10 to-transparent rounded-bl-full pointer-events-none -mr-16 -mt-16">
                    </div>
                    <div className="flex flex-col md:flex-row gap-6 md:items-center relative z-10">
                      {/* Avatar */}
                      <div className="relative shrink-0">
                        <div className="size-24 md:size-32 rounded-full border-4 border-white shadow-md bg-cover bg-center" data-alt="Patient Portrait" style={{backgroundImage: "url(\"/placeholder.svg\")"}}>
                        </div>
                        <div className="absolute bottom-1 right-1 bg-green-500 border-2 border-white size-5 rounded-full" title="Online / Cadastro Ativo">
                        </div>
                      </div>
                      {/* Info */}
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
                      ...
                      <div className="space-y-6">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-8">
                            ...
                            <div className="group">
                              ...
                              <div className="flex items-center gap-2">
                                <span className="text-text-main font-medium font-mono text-base bg-gray-50 px-2 py-1 rounded border border-transparent group-hover:border-border-light transition-colors">
                                  (11) 9****-8821
                                </span>
                            ...
                            <div className="md:col-span-2 group">
                              ...
                              <div className="flex items-center gap-2">
                                <span className="text-text-main font-medium text-base truncate">
                          ...
                          <div className="bg-white rounded-xl shadow-sm border border-border-light p-6 flex flex-col h-full">
                            ...
                            <div className="bg-yellow-50/50 p-4 rounded-lg border border-yellow-100 flex-1 min-h-[120px]">
                              <p className="text-sm text-gray-700 leading-relaxed">
                                ...
                                Documento atualizado em 12/01/2023.
                              </p>
                            </div>
                            <button className="mt-3 text-xs text-text-secondary hover:text-primary-dark font-medium self-end">
                              Adicionar nota
                            </button>
                          </div>
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-border-light overflow-hidden">
                          <div className="px-6 py-4 border-b border-border-light flex justify-between items-center bg-gray-50/50">
                            ...
                            <a className="text-xs font-bold text-primary-dark hover:underline" href="#">
                              Ver todos
                            </a>
                          </div>
                              ...
                              <tbody className="divide-y divide-border-light">
                                <tr className="hover:bg-gray-50/50 transition-colors">
                                  ...
                                  <td className="px-6 py-4 flex items-center gap-2">
                                    <div className="size-6 rounded-full bg-gray-200 bg-cover" data-alt="Doctor Avatar" style={{backgroundImage: "url(\"/placeholder.svg\")"}}>
                                    </div>
                                    Dr. House
                                  </td>
                                  <td className="px-6 py-4">
                    ...
                    <div className="lg:col-span-1 space-y-6">
                      ...
                      <div className="bg-gradient-to-br from-primary to-primary-dark rounded-xl shadow-lg p-6 text-white relative overflow-hidden group">
                        ...
                        <h3 className="text-white/80 text-sm font-semibold uppercase tracking-wider mb-2">
                          Próximo Agendamento
                        </h3>
                      ...
                      <div className="bg-white rounded-xl shadow-sm border border-border-light p-6">
                        ...
                        <div className="relative pl-4 border-l border-border-light space-y-6">
                          ...
                          <div className="relative">
                            <div className="absolute -left-[21px] top-1 bg-primary size-3 rounded-full border-2 border-white shadow-sm">
                            </div>
                            <p className="text-sm font-medium text-text-main">
                          ...
                          {/* Item 2 */}
                          <div className="relative">
                            <div className="absolute -left-[21px] top-1 bg-gray-300 size-3 rounded-full border-2 border-white">
                            </div>
                            <p className="text-sm font-medium text-text-main">
                              Lembrete SMS Enviado
                            </p>
                            <p className="text-xs text-text-secondary mt-0.5">
                              Sistema Automático
                            </p>
                          ...
                          <button className="text-xs text-primary-dark font-semibold hover:underline mt-2">
                  ...
                  <div className="text-center py-6">
                    <p className="text-xs text-gray-400">
                      © 2023 LifeMed Systems. Dados protegidos por criptografia de ponta a ponta.
                    </p>
                  </div>
                </div>
              </main>
