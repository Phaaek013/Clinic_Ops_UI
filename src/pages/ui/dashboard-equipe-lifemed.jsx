...
export function DashboardEquipeLifemed() {
  return (
    <div className="ui-page ui-dashboard-equipe-lifemed bg-background-light dark:bg-background-dark text-text-main antialiased h-screen flex overflow-hidden">
{/*Sidebar*/}
...
<h1 className="text-text-main text-lg font-bold leading-tight">LifeMed</h1>
<p className="text-text-muted text-xs font-medium uppercase tracking-wide">ClinicOps</p>
</div>
</div>
{/*Nav Items*/}
...
<span className="material-symbols-outlined text-primary-dark" style={{fontVariationSettings: '\'FILL\' 1'}}>dashboard</span>
...
<div className="flex flex-col">
<span className="text-text-main text-sm font-medium">Painel Admin</span>
<span className="text-[10px] text-text-muted bg-gray-100 px-1.5 py-0.5 rounded w-fit">ADMINISTRADOR</span>
</div>
</div>
...
<h2 className="text-xl font-bold text-text-main hidden md:block">Dashboard</h2>
<div className="h-6 w-px bg-gray-200 hidden md:block"></div>
<div className="flex items-center gap-2 bg-background-light p-1 rounded-lg border border-gray-200">
<button className="px-3 py-1 bg-white shadow-sm rounded border border-gray-100 text-xs font-semibold text-text-main hover:bg-gray-50">Hoje</button>
<div className="flex items-center gap-2 px-2">
<span className="material-symbols-outlined text-text-muted text-[18px]">calendar_today</span>
<span className="text-sm font-medium text-text-main">14 Out, 2023</span>
...
<span className="absolute left-3 top-1/2 -translate-y-1/2 material-symbols-outlined text-text-muted text-[20px]">stethoscope</span>
...
<p className="text-sm font-bold text-text-main leading-none">Admin</p>
<p className="text-xs text-text-muted leading-none mt-1">Gestor</p>
</div>
<button className="size-9 rounded-full bg-gray-200 bg-cover bg-center border-2 border-white shadow-sm" data-alt="Avatar do usuário logado" style={{backgroundImage: 'url(\'/logo.svg\')'}}></button>
</div>
</div>
</header>
{/*Scrollable Content*/}
...
<span className="material-symbols-outlined text-primary text-4xl opacity-50">calendar_today</span>
</div>
<p className="text-text-muted text-sm font-medium z-10">Agendamentos hoje</p>
<div className="flex items-end gap-2 z-10">
<h3 className="text-3xl font-bold text-text-main">42</h3>
...
<p className="text-text-muted text-sm font-medium z-10">Pendentes confirmação</p>
<div className="flex items-end gap-2 z-10">
...
<p className="text-text-muted text-sm font-medium z-10">Lista de espera</p>
<div className="flex items-end gap-2 z-10">
<h3 className="text-3xl font-bold text-text-main">12</h3>
...
<p className="text-text-muted text-sm font-medium z-10">Faltas ontem</p>
<div className="flex items-end gap-2 z-10">
<h3 className="text-3xl font-bold text-text-main">3</h3>
<span className="text-text-muted text-xs font-medium mb-1">vs 2 semana passada</span>
</div>
</div>
</div>
...
<h3 className="text-lg font-bold text-text-main">Agenda de hoje</h3>
...
<button className="px-3 py-1.5 rounded-full bg-primary/10 text-primary-dark text-xs font-bold whitespace-nowrap border border-primary/20">Todos (42)</button>
<button className="px-3 py-1.5 rounded-full bg-gray-50 text-text-muted hover:bg-gray-100 text-xs font-bold whitespace-nowrap border border-transparent">Confirmados (24)</button>
<button className="px-3 py-1.5 rounded-full bg-gray-50 text-text-muted hover:bg-gray-100 text-xs font-bold whitespace-nowrap border border-transparent">Pendentes (8)</button>
<button className="px-3 py-1.5 rounded-full bg-gray-50 text-text-muted hover:bg-gray-100 text-xs font-bold whitespace-nowrap border border-transparent">Finalizados (10)</button>
</div>
{/*Table*/}
...
<td className="px-5 py-3 font-bold text-text-main text-sm">08:00</td>
<td className="px-5 py-3">
<div className="flex items-center gap-3">
<div className="size-8 rounded-full bg-gray-200 bg-cover bg-center" data-alt="Avatar paciente Maria" style={{backgroundImage: 'url(\'/logo.svg\')'}}></div>
<div>
<p className="text-sm font-semibold text-text-main">Maria Silva</p>
<p className="text-xs text-text-muted">Particular</p>
</div>
</div>
</td>
<td className="px-5 py-3 text-sm text-text-main">Consulta Cardiologia</td>
<td className="px-5 py-3 text-sm text-text-muted hidden sm:table-cell">Dr. Roberto</td>
<td className="px-5 py-3">
...
{/*Row 2*/}
<tr className="hover:bg-[#f8fcfc] transition-colors group">
<td className="px-5 py-3 font-bold text-text-main text-sm">08:30</td>
<td className="px-5 py-3">
<div className="flex items-center gap-3">
...
<div>
<p className="text-sm font-semibold text-text-main">João Pereira</p>
<p className="text-xs text-text-muted">Unimed</p>
</div>
</div>
</td>
<td className="px-5 py-3 text-sm text-text-main">Retorno Exames</td>
<td className="px-5 py-3 text-sm text-text-muted hidden sm:table-cell">Dra. Ana</td>
<td className="px-5 py-3">
...
{/*Row 3*/}
<tr className="hover:bg-[#f8fcfc] transition-colors group">
<td className="px-5 py-3 font-bold text-text-main text-sm">09:00</td>
<td className="px-5 py-3">
<div className="flex items-center gap-3">
<div className="size-8 rounded-full bg-gray-200 bg-cover bg-center" data-alt="Avatar paciente Carlos" style={{backgroundImage: 'url(\'/logo.svg\')'}}></div>
<div>
<p className="text-sm font-semibold text-text-main">Carlos Souza</p>
<p className="text-xs text-text-muted">Particular</p>
</div>
</div>
</td>
<td className="px-5 py-3 text-sm text-text-main">Ecocardiograma</td>
<td className="px-5 py-3 text-sm text-text-muted hidden sm:table-cell">Dr. Roberto</td>
<td className="px-5 py-3">
...
{/*Row 4*/}
<tr className="hover:bg-[#f8fcfc] transition-colors group">
<td className="px-5 py-3 font-bold text-text-main text-sm">09:30</td>
<td className="px-5 py-3">
<div className="flex items-center gap-3">
<div className="size-8 rounded-full bg-pink-100 flex items-center justify-center text-pink-600 font-bold text-xs">LG</div>
<div>
<p className="text-sm font-semibold text-text-main">Luana Gomes</p>
<p className="text-xs text-text-muted">Bradesco Saúde</p>
</div>
</div>
</td>
<td className="px-5 py-3 text-sm text-text-main">Consulta Dermatologia</td>
<td className="px-5 py-3 text-sm text-text-muted hidden sm:table-cell">Dra. Ana</td>
<td className="px-5 py-3">
...
<button className="text-sm font-medium text-primary hover:text-primary-dark transition-colors">Ver agenda completa</button>
</div>
</div>
</div>
...
<a className="text-xs font-bold text-primary hover:underline" href="#">Abrir Fila</a>
</div>
...
<p className="text-text-muted text-sm font-semibold uppercase tracking-wider mb-2">Senha Atual</p>
<div className="text-6xl font-black text-text-main tracking-tight mb-6">A042</div>
...
<p className="text-xs text-text-muted font-medium text-left mb-3 pl-1">Próximas senhas:</p>
<div className="flex gap-2 overflow-x-auto pb-2 hide-scrollbar">
<div className="bg-gray-50 border border-gray-200 rounded px-3 py-1.5 text-sm font-bold text-text-main whitespace-nowrap">A043</div>
<div className="bg-gray-50 border border-gray-200 rounded px-3 py-1.5 text-sm font-bold text-text-main whitespace-nowrap">A044</div>
<div className="bg-gray-50 border border-gray-200 rounded px-3 py-1.5 text-sm font-bold text-text-main whitespace-nowrap">N102</div>
<div className="bg-gray-50 border border-gray-200 rounded px-3 py-1.5 text-sm font-bold text-text-muted whitespace-nowrap">...</div>
</div>
</div>
</div>
</div>
...
<span className="material-symbols-outlined text-orange-400 text-[20px]">mark_chat_unread</span>
...
<div className="flex items-center gap-3">
<div className="size-9 rounded-full bg-gray-100 flex items-center justify-center text-gray-500 font-bold text-xs">CS</div>
<div>
<p className="text-sm font-semibold text-text-main">Carlos Souza</p>
<p className="text-xs text-text-muted">Hoje, 09:00 - Ecocardiograma</p>
</div>
</div>
...
<div>
<p className="text-sm font-semibold text-text-main">Mariana Alves</p>
<p className="text-xs text-text-muted">Hoje, 14:15 - Retorno</p>
</div>
</div>
<div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
<button className="size-8 flex items-center justify-center rounded-full bg-green-100 text-green-600 hover:bg-green-200 transition-colors" title="Confirmar">
...
<button className="text-xs font-bold text-text-muted hover:text-primary transition-colors">Ver todas pendências</button>
</div>
</div>
{/*Task 2: Waitlist*/}
<div className="bg-white rounded-xl border border-gray-100 shadow-sm flex flex-col">
...
<h3 className="text-base font-bold text-text-main flex items-center gap-2">
<span className="material-symbols-outlined text-blue-400 text-[20px]">person_add</span>
...
<div className="flex flex-col">
<p className="text-sm font-semibold text-text-main">Fernando Torres</p>
<div className="flex items-center gap-2 mt-0.5">
<span className="text-[10px] font-bold bg-gray-100 text-gray-600 px-1.5 rounded">Cardiologia</span>
<span className="text-xs text-text-muted">Prefere manhã</span>
</div>
</div>
...
<li className="flex items-center justify-between p-3 hover:bg-gray-50 rounded-lg group transition-colors border-l-2 border-transparent hover:border-blue-400">
<div className="flex flex-col">
<p className="text-sm font-semibold text-text-main">Beatriz Lima</p>
<div className="flex items-center gap-2 mt-0.5">
<span className="text-[10px] font-bold bg-gray-100 text-gray-600 px-1.5 rounded">Dermatologia</span>
<span className="text-xs text-text-muted">Qualquer horário</span>
</div>
</div>
<button className="text-xs font-bold text-primary hover:text-primary-dark border border-primary/30 hover:bg-primary/5 px-3 py-1.5 rounded-lg transition-colors flex items-center gap-1">
<span className="material-symbols-outlined text-[14px]">calendar_add_on</span>
...
<div className="px-5 py-3 border-t border-gray-100 text-center">
<button className="text-xs font-bold text-text-muted hover:text-primary transition-colors">Gerenciar lista completa</button>
</div>
</div>
</div>
</div>
