...
export function UiRelatoriosLifemedClinicopsPage() {
  return (
    <section className="ui-stitch-screen" data-route="/ui/relatorios-lifemed-clinicops">
      <html className="light" lang="pt-BR">
        <head>
          <meta charset="utf-8" />
          <meta content="width=device-width, initial-scale=1.0" name="viewport" />
          <title>
            LifeMed ClinicOps - Relatórios
          </title>
          {/* Fonts */}
        ...
        <body className="font-display bg-background-light text-text-main antialiased overflow-hidden h-screen flex">
          {/* Sidebar */}
          <aside className="w-64 bg-surface-light border-r border-border-color hidden md:flex flex-col h-full shrink-0 z-20">
            <div className="p-6 flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <h1 className="text-text-main text-base font-bold leading-normal">
                  LifeMed
                </h1>
            ...
            <nav className="flex-1 overflow-y-auto px-4 py-2 space-y-1">
              <a className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-text-main hover:bg-background-light group transition-colors" href="#">
                <span className="material-symbols-outlined text-[24px] text-text-secondary group-hover:text-text-main">
                  dashboard
                </span>
              ...
              <a className="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-[#e7f3f3] text-text-main" href="#">
                <span className="material-symbols-outlined text-[24px] text-primary-dark font-fill">
                  bar_chart
                </span>
            ...
            <div className="p-4 border-t border-border-color">
              <div className="flex items-center gap-3 px-3 py-2">
                <div className="size-8 rounded-full bg-gray-200 bg-center bg-cover" data-alt="User profile avatar" style={{backgroundImage: "url(\"/placeholder.svg\")"}}>
                </div>
          ...
          <div className="flex flex-col flex-1 h-full min-w-0 bg-background-light">
            ...
            <header className="bg-surface-light border-b border-border-color px-6 py-3 flex items-center justify-between shrink-0 h-16">
              <div className="flex items-center gap-4">
                ...
                <h2 className="text-lg font-bold text-text-main hidden sm:block">
            ...
            <main className="flex-1 overflow-y-auto overflow-x-hidden p-6 relative">
              <div className="max-w-[1200px] mx-auto space-y-6 pb-10">
                ...
                <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
                  <div>
                    ...
                    <p className="text-text-secondary mt-1">
                      Indicadores de performance e saúde operacional da clínica.
                    </p>
                  </div>
                  <div className="flex gap-2">
                  ...
                  <div className="flex flex-wrap items-center gap-3">
                    ...
                    <div className="flex items-center gap-2 bg-background-light rounded-lg px-3 py-2 border border-border-color min-w-[240px]">
                      ...
                      <select className="bg-transparent border-none text-sm font-medium text-text-main focus:ring-0 p-0 w-full cursor-pointer">
                        <option>
                          Este Mês (01 Out - 31 Out)
                        </option>
                        <option>
                          Mês Passado (01 Set - 30 Set)
                        </option>
                        <option>
                          Últimos 7 dias
                        </option>
                    ...
                    <div className="relative group">
                      <button className="flex items-center gap-2 px-3 py-2 rounded-lg border border-border-color hover:bg-background-light text-sm font-medium text-text-main transition-colors">
                        ...
                        Status: Concluído
                        <span className="px-1.5 py-0.5 rounded-full bg-primary/20 text-text-main text-xs font-bold">
                          1
                        </span>
                        <span className="material-symbols-outlined text-[18px]">
                          expand_more
                    ...
                    {/* Filter Actions */}
                    <button className="text-sm font-medium text-text-secondary hover:text-primary-dark transition-colors px-3">
                      Limpar filtros
                    </button>
                    <button className="text-sm font-bold text-primary-dark bg-primary/10 hover:bg-primary/20 px-3 py-2 rounded-lg transition-colors">
                      Salvar visão
                    </button>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  <div className="bg-surface-light p-5 rounded-xl border border-border-color shadow-sm hover:shadow-md transition-shadow">
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <span className="material-symbols-outlined text-primary-dark p-1 bg-primary/10 rounded-md">
                        event_available
                      </span>
                    </div>
                  ...
                  <div className="bg-surface-light p-5 rounded-xl border border-border-color shadow-sm hover:shadow-md transition-shadow">
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <span className="material-symbols-outlined text-blue-600 p-1 bg-blue-50 rounded-md">
                        pie_chart
                      </span>
                    </div>
                    <div className="flex items-end gap-2">
                  ...
                  <div className="bg-surface-light p-5 rounded-xl border border-border-color shadow-sm hover:shadow-md transition-shadow">
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <span className="material-symbols-outlined text-orange-500 p-1 bg-orange-50 rounded-md">
                        person_off
                      </span>
                    </div>
                    <div className="flex items-end gap-2">
                  ...
                  <div className="bg-surface-light p-5 rounded-xl border border-border-color shadow-sm hover:shadow-md transition-shadow">
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <span className="material-symbols-outlined text-purple-600 p-1 bg-purple-50 rounded-md">
                        hourglass_empty
                      </span>
                    </div>
                    <div className="flex items-end gap-2">
                ...
                <div className="bg-surface-light p-6 rounded-xl border border-border-color shadow-sm">
                  <div className="flex items-center justify-between mb-6">
                    <div>
                      ...
                      <p className="text-sm text-text-secondary">
                        Comparativo Diário: Realizados vs Cancelados
                      </p>
                    </div>
                  ...
                  <div className="relative h-64 w-full flex items-end justify-between gap-1 sm:gap-2 px-2 pb-6 border-b border-border-color">
                    ...
                    <div className="group relative flex-1 flex flex-col justify-end gap-1 h-full hover:bg-gray-50 rounded-t cursor-pointer transition-colors" title="Day 1">
                      <div className="w-full bg-gray-300 rounded-t-sm" style={{height: "15%"}}>
                      </div>
                      <div className="w-full bg-primary rounded-t-sm" style={{height: "40%"}}>
                      </div>
                    </div>
                    <div className="group relative flex-1 flex flex-col justify-end gap-1 h-full hover:bg-gray-50 rounded-t cursor-pointer transition-colors" title="Day 2">
                      <div className="w-full bg-gray-300 rounded-t-sm" style={{height: "10%"}}>
                      </div>
                      <div className="w-full bg-primary rounded-t-sm" style={{height: "55%"}}>
                      </div>
                    </div>
                    <div className="group relative flex-1 flex flex-col justify-end gap-1 h-full hover:bg-gray-50 rounded-t cursor-pointer transition-colors" title="Day 3">
                      <div className="w-full bg-gray-300 rounded-t-sm" style={{height: "5%"}}>
                      </div>
                    ...
                    <div className="group relative flex-1 flex flex-col justify-end gap-1 h-full hover:bg-gray-50 rounded-t cursor-pointer transition-colors" title="Day 4">
                      <div className="w-full bg-gray-300 rounded-t-sm" style={{height: "20%"}}>
                      </div>
                      <div className="w-full bg-primary rounded-t-sm" style={{height: "60%"}}>
                      </div>
                    </div>
                    <div className="group relative flex-1 flex flex-col justify-end gap-1 h-full hover:bg-gray-50 rounded-t cursor-pointer transition-colors" title="Day 5">
                      <div className="w-full bg-gray-300 rounded-t-sm" style={{height: "12%"}}>
                      </div>
                      <div className="w-full bg-primary rounded-t-sm" style={{height: "75%"}}>
                      </div>
                    </div>
                    <div className="group relative flex-1 flex flex-col justify-end gap-1 h-full hover:bg-gray-50 rounded-t cursor-pointer transition-colors" title="Day 6">
                      <div className="w-full bg-gray-300 rounded-t-sm" style={{height: "8%"}}>
                      </div>
                      <div className="w-full bg-primary rounded-t-sm" style={{height: "45%"}}>
                      </div>
                    </div>
                    <div className="group relative flex-1 flex flex-col justify-end gap-1 h-full hover:bg-gray-50 rounded-t cursor-pointer transition-colors" title="Day 7">
                      <div className="w-full bg-gray-300 rounded-t-sm" style={{height: "18%"}}>
                      </div>
                      <div className="w-full bg-primary rounded-t-sm" style={{height: "65%"}}>
                      </div>
                    </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="bg-surface-light p-6 rounded-xl border border-border-color shadow-sm flex flex-col">
                    <div className="flex justify-between items-center mb-4">
                      ...
                      <button className="text-primary-dark text-xs font-bold uppercase tracking-wide hover:underline">
                        Ver tabela
                      </button>
                    </div>
                  ...
                  <div className="bg-surface-light p-6 rounded-xl border border-border-color shadow-sm flex flex-col">
                    ...
                    <div className="space-y-4 flex-1">
                      ...
                      <div className="flex items-center gap-3">
                        <div className="size-8 rounded-full bg-gray-200 bg-center bg-cover" data-alt="Avatar of Dr. Almeida" style={{backgroundImage: "url(\"/placeholder.svg\")"}}>
                        </div>
                      ...
                      {/* Profile 2 */}
                      <div className="flex items-center gap-3">
                        <div className="size-8 rounded-full bg-gray-200 bg-center bg-cover" data-alt="Avatar of Dra. Beatriz" style={{backgroundImage: "url(\"/placeholder.svg\")"}}>
                        </div>
                        <div className="flex-1 space-y-1">
                          <div className="flex justify-between text-sm">
                            <span className="text-text-main font-medium">
                      ...
                      {/* Profile 3 */}
                      <div className="flex items-center gap-3">
                        <div className="size-8 rounded-full bg-gray-200 bg-center bg-cover" data-alt="Avatar of Dr. Carlos" style={{backgroundImage: "url(\"/placeholder.svg\")"}}>
                        </div>
                        <div className="flex-1 space-y-1">
                          <div className="flex justify-between text-sm">
                            <span className="text-text-main font-medium">
                ...
                <div className="bg-surface-light rounded-xl border border-border-color shadow-sm overflow-hidden">
                  <div className="p-6 border-b border-border-color flex flex-col sm:flex-row justify-between gap-4">
                    <div>
                      ...
                      <p className="text-sm text-text-secondary">
                        Detalhamento dos agendamentos do período.
                      </p>
                    </div>
                    <div className="flex gap-2">
                    ...
                    <table className="w-full text-left text-sm">
                      ...
                      <tbody className="divide-y divide-border-color">
                        <tr className="hover:bg-background-light/50 transition-colors">
                          ...
                          <td className="px-6 py-4 text-text-main font-bold text-right">
                            480
                          </td>
                          <td className="px-6 py-4 text-red-500 text-right">
                            24
                          </td>
                          <td className="px-6 py-4 text-orange-500 text-right">
                            20 (3.8%)
                          </td>
                  ...
                  <div className="p-4 border-t border-border-color bg-background-light/30 flex items-center justify-between text-xs text-text-secondary">
                    <p>
                      Mostrando 4 de 12 serviços
                    </p>
                    <div className="flex gap-2">
                      <button className="px-3 py-1 border border-border-color rounded bg-white hover:bg-gray-50 disabled:opacity-50">
                        Anterior
                      </button>
                      <button className="px-3 py-1 border border-border-color rounded bg-white hover:bg-gray-50">
                        Próximo
                      </button>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-center gap-2 text-xs text-text-secondary py-4">
                  ...
                  <span>
                    Dados sensíveis de pacientes estão ocultos nesta visão. Utilize a exportação detalhada para acesso completo.
                  </span>
                </div>
              </div>
            </main>
