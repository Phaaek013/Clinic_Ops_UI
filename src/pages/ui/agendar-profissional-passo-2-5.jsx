...
export function UiAgendarProfissionalPasso25Page() {
  return (
    <section className="ui-stitch-screen" data-route="/ui/agendar-profissional-passo-2-5">
      <html className="light" lang="pt-BR">
        <head>
          <meta charset="utf-8" />
          <meta content="width=device-width, initial-scale=1.0" name="viewport" />
          <title>
            Agendar: Profissional - LifeMed ClinicOps
          </title>
          {/* Fonts & Icons */}
        ...
        <body className="bg-background-light dark:bg-background-dark text-text-main dark:text-white font-display overflow-x-hidden flex flex-col min-h-screen">
          {/* Header & Breadcrumbs */}
          <div className="w-full px-4 md:px-10 lg:px-40 py-5 bg-background-light dark:bg-background-dark">
            <div className="max-w-[1280px] mx-auto flex flex-col gap-4">
              {/* Breadcrumbs */}
              <div className="flex flex-wrap gap-2 items-center text-sm">
                <a className="text-text-secondary hover:text-primary transition-colors font-medium leading-normal" href="#">
                  Início
                </a>
                <span className="text-text-secondary font-medium leading-normal material-symbols-outlined text-[16px]">
                  chevron_right
                </span>
                <span className="text-text-main dark:text-gray-200 font-medium leading-normal">
                  Agendar
                </span>
              </div>
              {/* Page Heading */}
            ...
            <div className="max-w-[1280px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8">
              ...
              <div className="lg:col-span-8 flex flex-col gap-6">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-text-main dark:text-white text-base font-bold">
                        Consulta Cardiológica - Primeira Vez
                      </p>
                    </div>
                  </div>
                  <button className="text-sm font-semibold text-primary-dark dark:text-primary hover:underline whitespace-nowrap">
                    Trocar serviço
                  </button>
                </div>
                {/* Filters & Search */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="flex items-start gap-4">
                      <div className="relative shrink-0">
                        <div className="w-16 h-16 rounded-full overflow-hidden bg-gray-200">
                          <img className="w-full h-full object-cover" data-alt="Portrait of Dr. Roberto Silva, smiling male doctor in white coat" src="/placeholder.svg" />
                        </div>
                        <div className="absolute bottom-0 right-0 w-4 h-4 rounded-full bg-green-500 border-2 border-white dark:border-surface-dark" title="Disponível agora">
                        </div>
                      </div>
                      <div className="flex flex-col pt-1">
                        ...
                        <div className="flex items-center gap-1 mt-1">
                          ...
                          <span className="text-xs font-semibold text-text-main dark:text-gray-200">
                            4.9
                          </span>
                  ...
                  <label className="cursor-pointer relative flex flex-col bg-surface-light dark:bg-surface-dark rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm transition-all hover:border-primary/50 hover:shadow-md p-5 gap-4 group">
                    ...
                    <div className="flex items-start gap-4">
                      <div className="relative shrink-0">
                        <div className="w-16 h-16 rounded-full overflow-hidden bg-gray-200">
                          <img className="w-full h-full object-cover" data-alt="Portrait of Dr. Ana Souza, female doctor wearing glasses and white coat" src="/placeholder.svg" />
                        </div>
                        <div className="absolute bottom-0 right-0 w-4 h-4 rounded-full bg-green-500 border-2 border-white dark:border-surface-dark">
                        </div>
                      </div>
                      <div className="flex flex-col pt-1">
                        <h3 className="text-base font-bold text-text-main dark:text-white">
                  ...
                  <label className="cursor-pointer relative flex flex-col bg-surface-light dark:bg-surface-dark rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm transition-all hover:border-primary/50 hover:shadow-md p-5 gap-4 group">
                    ...
                    <div className="flex items-start gap-4">
                      <div className="relative shrink-0">
                        <div className="w-16 h-16 rounded-full overflow-hidden bg-gray-200">
                          <img className="w-full h-full object-cover" data-alt="Portrait of Dr. Carlos Mendes, older male doctor with grey hair" src="/placeholder.svg" />
                        </div>
                ...
                <div className="flex justify-center pt-4">
                  <button className="text-sm font-semibold text-text-secondary hover:text-primary-dark transition-colors">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-2 mt-1">
                            <div className="w-6 h-6 rounded-full overflow-hidden bg-gray-200 shrink-0">
                              <img className="w-full h-full object-cover" data-alt="Mini portrait of Dr. Roberto" src="/placeholder.svg" />
                            </div>
                            <p className="text-sm font-bold text-text-main dark:text-white">
                              Dr. Roberto Silva
                            </p>
          ...
          <div className="h-24 bg-gray-50 dark:bg-[#0c1a1a]">
          </div>
        </body>
      </html>
    </section>
