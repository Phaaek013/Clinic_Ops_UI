...
export function DisponibilidadeRegrasSeman() {
  return (
    <div className="ui-page ui-disponibilidade-regras-seman font-display bg-background-light text-[#0d1b1b] overflow-hidden">
...
<div className="bg-center bg-no-repeat aspect-square bg-cover rounded-full size-10 shadow-sm border border-white" data-alt="LifeMed abstract medical cross logo in teal and cyan gradient" style={{backgroundImage: 'url(\'/logo.svg\')'}}></div>
<div className="flex flex-col justify-center">
<h1 className="text-[#0d1b1b] text-lg font-bold leading-tight tracking-tight">LifeMed</h1>
<p className="text-[#4c9a9a] text-xs font-semibold uppercase tracking-wider">ClinicOps</p>
</div>
</div>
{/*Navigation*/}
...
<p className="text-sm font-semibold leading-normal">Agenda</p>
</a>
<a className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-[#4c9a9a] hover:bg-[#e7f3f3] hover:text-[#0d1b1b] transition-colors group" href="#">
<span className="material-symbols-outlined text-2xl group-hover:scale-105 transition-transform">group</span>
<p className="text-sm font-semibold leading-normal">Pacientes</p>
</a>
{/*Active Item*/}
<a className="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-[#e7f3f3] text-[#0d1b1b] shadow-sm ring-1 ring-[#d0e8e8]" href="#">
<span className="material-symbols-outlined text-2xl text-teal-700 font-variation-fill">schedule</span>
<p className="text-sm font-bold leading-normal">Disponibilidade</p>
</a>
<a className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-[#4c9a9a] hover:bg-[#e7f3f3] hover:text-[#0d1b1b] transition-colors group" href="#">
<span className="material-symbols-outlined text-2xl group-hover:scale-105 transition-transform">settings</span>
<p className="text-sm font-semibold leading-normal">Configurações</p>
</a>
</nav>
</div>
...
<p className="text-sm font-semibold leading-normal">Sair</p>
</a>
</div>
</aside>
{/*MAIN CONTENT AREA*/}
...
<span className="material-symbols-outlined text-[#13ecec]">admin_panel_settings</span>
<h2 className="text-[#0d1b1b] text-lg font-bold leading-tight">Admin Console</h2>
</div>
</div>
<div className="flex flex-1 justify-end gap-6 items-center">
<div className="hidden sm:flex items-center bg-[#f8fcfc] rounded-full px-3 py-1.5 border border-[#e7f3f3]">
<span className="material-symbols-outlined text-[#4c9a9a] text-lg">search</span>
...
<span className="absolute top-0 right-0 size-2.5 bg-[#13ecec] rounded-full border-2 border-white"></span>
</button>
...
<p className="text-sm font-bold text-[#0d1b1b]">Dra. Ana Silva</p>
<p className="text-xs text-[#4c9a9a]">Administradora</p>
</div>
<div className="bg-center bg-no-repeat aspect-square bg-cover rounded-full size-9 ring-2 ring-offset-1 ring-[#13ecec]" data-alt="Portrait of a female doctor smiling" style={{backgroundImage: 'url(\'/logo.svg\')'}}></div>
</div>
</div>
</header>
{/*CONTENT SCROLLABLE*/}
...
<a className="text-[#4c9a9a] hover:text-[#13ecec] font-medium transition-colors" href="#">Home</a>
<span className="text-[#cbd5e1] font-medium">/</span>
<a className="text-[#4c9a9a] hover:text-[#13ecec] font-medium transition-colors" href="#">Disponibilidade</a>
<span className="text-[#cbd5e1] font-medium">/</span>
<span className="text-[#0d1b1b] font-bold bg-[#e7f3f3] px-2 py-0.5 rounded text-xs tracking-wide">REGRAS</span>
</div>
{/*Page Heading*/}
<div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
<div className="flex flex-col gap-2">
<h1 className="text-[#0d1b1b] text-3xl font-extrabold tracking-tight">Regras semanais</h1>
<p className="text-[#4c9a9a] text-base max-w-xl">Defina os horários de atendimento padrão. Estas configurações alimentam a agenda e o sistema de autoagendamento online.</p>
</div>
...
<span className="material-symbols-outlined text-[16px] text-[#13ecec]">lock</span>
                            Somente ADMIN
                        </span>
</div>
{/*Tabs*/}
...
<label className="text-xs font-bold uppercase text-[#4c9a9a] tracking-wider" htmlFor="scope-select">Configurar Para</label>
...
<span className="material-symbols-outlined absolute left-3 top-2.5 text-[#4c9a9a]">domain</span>
</div>
</div>
<div className="md:col-span-4 flex flex-col gap-2">
<label className="text-xs font-bold uppercase text-[#4c9a9a] tracking-wider" htmlFor="professional-select">Selecionar Profissional</label>
<div className="relative">
...
<span className="material-symbols-outlined absolute left-3 top-2.5 text-[#4c9a9a] text-[20px]">person</span>
</div>
</div>
...
<label className="text-sm font-medium text-[#0d1b1b] cursor-pointer" htmlFor="online-booking">Online</label>
...
<h3 className="text-lg font-bold text-[#0d1b1b]">Grade de Horários</h3>
...
<div>
<span className="block text-sm font-bold text-[#0d1b1b]">Segunda-feira</span>
<span className="block text-xs text-[#4c9a9a] font-medium">3 faixas</span>
</div>
</div>
{/*Time Slots*/}
...
<span className="text-[#4c9a9a]">-</span>
...
<div>
<span className="block text-sm font-bold text-[#0d1b1b]">Terça-feira</span>
...
<span className="text-xs text-red-500 font-bold px-2 py-1 bg-white rounded-md border border-red-100">Sobreposição detectada</span>
<button className="text-[#9ca3af] hover:text-red-500 transition-colors p-1 rounded-full hover:bg-red-50">
<span className="material-symbols-outlined text-[20px]">delete</span>
</button>
</div>
...
<div>
<span className="block text-sm font-medium text-[#4c9a9a]">Quarta-feira</span>
<span className="block text-xs text-[#9ca3af]">Fechado</span>
</div>
</div>
<div className="flex-1">
<p className="text-sm text-[#9ca3af] italic">Não há atendimento neste dia.</p>
</div>
</div>
</div>
{/*Day Row: Active*/}
...
<div>
<span className="block text-sm font-bold text-[#0d1b1b]">Quinta-feira</span>
<span className="block text-xs text-[#4c9a9a] font-medium">1 faixa</span>
</div>
</div>
<div className="flex-1 flex flex-col gap-3">
<div className="flex items-center gap-2 sm:gap-4 flex-wrap">
...
<div className="rounded-xl border border-[#e7f3f3] bg-white p-6 shadow-sm">
<h3 className="text-sm font-bold text-[#0d1b1b] uppercase tracking-wider mb-4 border-b border-[#e7f3f3] pb-2">Regras de Agendamento</h3>
<div className="space-y-4">
<div>
<label className="block text-sm font-medium text-[#4c9a9a] mb-1">Antecedência mínima</label>
...
<div>
<label className="block text-sm font-medium text-[#4c9a9a] mb-1">Janela máxima de agendamento</label>
<div className="flex gap-2">
...
<div className="rounded-xl border border-[#e7f3f3] bg-white p-6 shadow-sm">
<h3 className="text-sm font-bold text-[#0d1b1b] uppercase tracking-wider mb-4 border-b border-[#e7f3f3] pb-2">Política de Cancelamento</h3>
<div className="space-y-4">
<div>
<label className="block text-sm font-medium text-[#4c9a9a] mb-1">Permitir cancelamento pelo paciente?</label>
...
<div>
<label className="block text-sm font-medium text-[#4c9a9a] mb-1">Mensagem personalizada</label>
<textarea className="w-full rounded-lg border-[#e7f3f3] bg-[#f8fcfc] text-[#0d1b1b] text-sm focus:border-[#13ecec] focus:ring-[#13ecec]" placeholder="Ex: Para reagendar sem custo..." rows="2"></textarea>
</div>
</div>
</div>
</div>
