...
export function ProfissionaisLifemedClinicops() {
  return (
    <div className="ui-page ui-profissionais-lifemed-clinicops flex min-h-screen w-full flex-col bg-background-light dark:bg-background-dark font-display text-text-dark dark:text-text-light transition-colors duration-200">
{/*Top Navigation*/}
...
<h2 className="text-text-dark dark:text-white text-lg font-bold leading-tight tracking-[-0.015em]">LifeMed ClinicOps</h2>
</div>
<div className="hidden lg:flex flex-1 justify-end gap-8">
<nav className="flex items-center gap-9">
<a className="text-text-dark dark:text-gray-200 text-sm font-medium hover:text-primary transition-colors" href="#">Início</a>
<a className="text-text-dark dark:text-gray-200 text-sm font-bold text-primary" href="#">Especialidades</a>
<a className="text-text-dark dark:text-gray-200 text-sm font-medium hover:text-primary transition-colors" href="#">Exames</a>
<a className="text-text-dark dark:text-gray-200 text-sm font-medium hover:text-primary transition-colors" href="#">Profissionais</a>
<a className="text-text-dark dark:text-gray-200 text-sm font-medium hover:text-primary transition-colors" href="#">Contato</a>
</nav>
...
<a className="text-accent-teal hover:underline text-sm font-medium" href="#">Início</a>
<span className="text-accent-teal text-sm font-medium">/</span>
<span className="text-text-dark dark:text-white text-sm font-medium">Profissionais</span>
</div>
{/*Page Heading*/}
...
<h1 className="text-text-dark dark:text-white text-3xl md:text-4xl font-black tracking-tight">Profissionais</h1>
<p className="text-accent-teal text-base md:text-lg">Encontre o especialista ideal para o seu atendimento e agende sua consulta com praticidade.</p>
</div>
...
<span className="material-symbols-outlined text-accent-teal">search</span>
</div>
...
<span className="material-symbols-outlined text-accent-teal">expand_more</span>
</button>
</div>
</div>
{/*Filter Chips*/}
...
<img className="w-full h-full object-cover" data-alt="Female doctor smiling portrait" src="/avatar.svg" />
</div>
<div>
<h3 className="text-lg font-bold text-text-dark dark:text-white leading-tight group-hover:text-primary transition-colors">Dra. Ana Costa</h3>
<p className="text-accent-teal font-medium text-sm">Cardiologia</p>
</div>
</div>
<span className="material-symbols-outlined text-gray-300 dark:text-gray-600 hover:text-primary cursor-pointer">favorite</span>
</div>
{/*Badges*/}
...
<p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Próxima disponibilidade:</p>
...
<div className="flex items-center gap-3">
<div className="relative size-14 rounded-full overflow-hidden bg-gray-100">
<img className="w-full h-full object-cover" data-alt="Male doctor portrait with glasses" src="/avatar.svg" />
</div>
<div>
<h3 className="text-lg font-bold text-text-dark dark:text-white leading-tight group-hover:text-primary transition-colors">Dr. Carlos Mendes</h3>
<p className="text-accent-teal font-medium text-sm">Pediatria</p>
</div>
</div>
<span className="material-symbols-outlined text-gray-300 dark:text-gray-600 hover:text-primary cursor-pointer">favorite</span>
</div>
...
<div className="flex items-center gap-3">
<div className="relative size-14 rounded-full overflow-hidden bg-gray-100">
<img className="w-full h-full object-cover" data-alt="Female dermatologist portrait" src="/avatar.svg" />
</div>
<div>
<h3 className="text-lg font-bold text-text-dark dark:text-white leading-tight group-hover:text-primary transition-colors">Dra. Sofia Lima</h3>
<p className="text-accent-teal font-medium text-sm">Dermatologia</p>
</div>
</div>
<span className="material-symbols-outlined text-gray-300 dark:text-gray-600 hover:text-primary cursor-pointer">favorite</span>
</div>
...
<div className="flex items-center gap-3">
<div className="relative size-14 rounded-full overflow-hidden bg-gray-100">
<img className="w-full h-full object-cover" data-alt="Male orthopedist portrait" src="/avatar.svg" />
</div>
<div>
<h3 className="text-lg font-bold text-text-dark dark:text-white leading-tight group-hover:text-primary transition-colors">Dr. Ricardo Silva</h3>
<p className="text-accent-teal font-medium text-sm">Ortopedia</p>
</div>
</div>
<span className="material-symbols-outlined text-gray-300 dark:text-gray-600 hover:text-primary cursor-pointer">favorite</span>
</div>
...
<div className="flex items-center gap-3">
<div className="relative size-14 rounded-full overflow-hidden bg-gray-100">
<img className="w-full h-full object-cover" data-alt="Female nurse or doctor portrait" src="/avatar.svg" />
</div>
<div>
<h3 className="text-lg font-bold text-text-dark dark:text-white leading-tight group-hover:text-primary transition-colors">Enf. Julia Santos</h3>
<p className="text-accent-teal font-medium text-sm">Enfermagem</p>
</div>
</div>
<span className="material-symbols-outlined text-gray-300 dark:text-gray-600 hover:text-primary cursor-pointer">favorite</span>
</div>
...
<h2 className="text-2xl font-bold text-white dark:text-text-dark">Não sabe com quem agendar?</h2>
</div>
...
{/*<div className="flex flex-col items-center justify-center py-20 text-center hidden">
                <div className="size-20 bg-border-light dark:bg-surface-dark rounded-full flex items-center justify-center mb-4">
                    <span className="material-symbols-outlined text-4xl text-gray-400">person_off</span>
                </div>
                <h3 className="text-xl font-bold text-text-dark dark:text-white mb-2">Nenhum profissional encontrado</h3>
                <p className="text-gray-500 dark:text-gray-400 max-w-md">Não encontramos profissionais com os filtros selecionados. Tente buscar por outra especialidade ou limpe os filtros.</p>
                <button className="mt-6 text-primary font-bold hover:underline">Limpar filtros</button>
            </div>*/}
</div>
</main>
...
<p className="text-sm text-gray-400">© 2024 LifeMed ClinicOps. Todos os direitos reservados.</p>
</div>
</footer>
    </div>
  );
