...
export function UiDetalheAgendamentoLifemedPage() {
  return (
    <section className="ui-stitch-screen" data-route="/ui/detalhe-agendamento-lifemed">
      <html className="light" lang="pt-BR">
        <head>
          <meta charset="utf-8" />
          <meta content="width=device-width, initial-scale=1.0" name="viewport" />
          <title>
            Detalhe Agendamento - LifeMed ClinicOps
          </title>
        ...
        <body className="bg-background-light text-text-primary font-display antialiased overflow-x-hidden">
              ...
              <div className="flex flex-col h-full justify-between p-4">
                <div className="flex flex-col gap-6">
                  <div className="flex items-center gap-3 px-2">
                    <div className="bg-center bg-no-repeat bg-cover rounded-full size-10 shadow-sm" data-alt="LifeMed Logo - Abstract medical cross with leaves" style={{backgroundImage: "url(\"/placeholder.svg\")"}}>
                    </div>
                    <div className="flex flex-col">
                      <h1 className="text-text-primary text-lg font-bold leading-tight">
                        LifeMed
                      </h1>
                ...
                <div className="px-3 py-4 border-t border-surface-accent">
                  <div className="flex items-center gap-3">
                    <div className="bg-center bg-no-repeat bg-cover rounded-full size-10" data-alt="User Avatar" style={{backgroundImage: "url(\"/placeholder.svg\")"}}>
                    </div>
                    <div className="flex flex-col">
                  ...
                  <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                    <div className="flex flex-col gap-2">
                      <div className="flex items-center gap-3 flex-wrap">
                        ...
                        <span className="px-3 py-1 rounded-full bg-blue-100 text-blue-700 text-sm font-bold border border-blue-200">
                          Confirmado
                        </span>
                        <span className="px-3 py-1 rounded-full bg-surface-accent text-text-secondary text-sm font-medium border border-transparent">
                          Particular
                        </span>
                      </div>
                      <p className="text-text-secondary text-sm md:text-base">
                        Consulta Geral • 14 Out, 2023 • 10:00 - 10:30
                      </p>
                    </div>
                    ...
                    <div className="lg:col-span-2 flex flex-col gap-6">
                      ...
                      <div className="bg-white rounded-xl border border-surface-accent shadow-sm overflow-hidden">
                        ...
                        <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                          ...
                          <div className="flex flex-col gap-1.5">
                            ...
                            <div className="relative">
                              ...
                              <span className="absolute right-3 top-1/2 -translate-y-1/2 material-symbols-outlined text-text-secondary pointer-events-none text-xl">
                                expand_more
                              </span>
                            </div>
                          </div>
                          ...
                          <div className="md:col-span-2 p-3 rounded-lg bg-blue-50 border border-blue-100 flex items-start gap-3">
                            ...
                            <div className="flex flex-col gap-1">
                              ...
                              <p className="text-xs text-blue-600">
                                Este profissional tem disponibilidade para adiantar às 09:30.
                              </p>
                              <button className="text-xs font-bold text-blue-700 underline self-start mt-1">
                        ...
                        <div className="px-6 py-4 bg-gray-50 border-t border-surface-accent flex justify-end gap-3">
                          <button className="px-4 py-2 rounded-lg text-text-primary text-sm font-bold hover:bg-gray-200 transition-colors">
                            Descartar
                          </button>
                          <button className="px-4 py-2 rounded-lg bg-primary text-white text-sm font-bold shadow-md hover:bg-primary/90 transition-colors opacity-50 cursor-not-allowed">
                            Salvar Alterações
                          </button>
                        </div>
                      </div>
                      ...
                      <div className="bg-white rounded-xl border border-surface-accent shadow-sm p-6">
                        <h3 className="font-bold text-text-primary mb-4 text-sm uppercase tracking-wide">
                    ...
                    <div className="flex flex-col gap-6">
                      ...
                      <div className="bg-white rounded-xl border border-surface-accent shadow-sm p-6 flex flex-col gap-4">
                        ...
                        <div className="flex items-center gap-4">
                          <div className="size-14 rounded-full bg-cover bg-center shadow-inner" data-alt="Patient Profile Photo" style={{backgroundImage: "url(\"/placeholder.svg\")"}}>
                          </div>
                          <div>
                        ...
                        <div className="flex gap-2 flex-wrap pt-2">
                          <span className="px-2 py-1 bg-yellow-50 text-yellow-700 border border-yellow-200 rounded text-xs font-bold">
                            VIP
                          </span>
                          <span className="px-2 py-1 bg-purple-50 text-purple-700 border border-purple-200 rounded text-xs font-bold">
                            Alergia: Penicilina
                          </span>
                        </div>
                        <div className="grid grid-cols-2 gap-2 mt-2">
                          <button className="text-xs font-bold text-text-primary bg-gray-50 hover:bg-gray-100 py-2 rounded border border-surface-accent">
                            Copiar Contato
                          </button>
                          <button className="text-xs font-bold text-text-primary bg-gray-50 hover:bg-gray-100 py-2 rounded border border-surface-accent">
                            Lista de Espera
                      ...
                      {/* Policy / Finance Card */}
                      <div className="bg-white rounded-xl border border-surface-accent shadow-sm p-6">
                        <h3 className="font-bold text-text-primary text-sm uppercase tracking-wide mb-3">
                          Política
                          &amp;
                          Financeiro
                        </h3>
                        <div className="flex flex-col gap-3">
                          ...
                          <div className="text-xs text-text-secondary bg-blue-50 p-2 rounded border border-blue-100 mt-1">
                            ...
                            <p>
                              Cancelamento gratuito até 24h antes. Taxa de 50% após este prazo.
                            </p>
                          </div>
                        </div>
                      </div>
                      {/* Audit Timeline */}
                      <div className="bg-white rounded-xl border border-surface-accent shadow-sm p-6">
                        <h3 className="font-bold text-text-primary text-sm uppercase tracking-wide mb-4">
                          Histórico
                        </h3>
                        <div className="relative timeline-line flex flex-col gap-6 pl-2">
                          {/* Timeline Item 1 */}
                          <div className="relative z-10 pl-6">
                            <div className="absolute left-[9px] top-1 size-3 bg-primary rounded-full ring-4 ring-white">
                            </div>
                            <p className="text-sm font-bold text-text-primary">
                              Agendamento Confirmado
                            </p>
                            <p className="text-xs text-text-secondary mt-0.5">
                              Automático via WhatsApp • Hoje, 08:30
                            </p>
                          </div>
                          {/* Timeline Item 2 */}
                          <div className="relative z-10 pl-6">
                            <div className="absolute left-[9px] top-1 size-3 bg-gray-300 rounded-full ring-4 ring-white">
                            </div>
                            <p className="text-sm font-bold text-text-primary">
                              Lembrete Enviado
                            </p>
