...
export function PacientesLifemedClinicops() {
  return (
    <div className="ui-page ui-pacientes-lifemed-clinicops bg-background-light text-text-main font-display antialiased overflow-hidden">
...
<svg fill="currentColor" viewBox="0 0 48 48" xmlns="/avatar.svg">
<path d="M36.7273 44C33.9891 44 31.6043 39.8386 30.3636 33.69C29.123 39.8386 26.7382 44 24 44C21.2618 44 18.877 39.8386 17.6364 33.69C16.3957 39.8386 14.0109 44 11.2727 44C7.25611 44 4 35.0457 4 24C4 12.9543 7.25611 4 11.2727 4C14.0109 4 16.3957 8.16144 17.6364 14.31C18.877 8.16144 21.2618 4 24 4C26.7382 4 29.123 8.16144 30.3636 14.31C31.6043 8.16144 33.9891 4 36.7273 4C40.7439 4 44 12.9543 44 24C44 35.0457 40.7439 44 36.7273 44Z"></path>
</svg>
</div>
<h1 className="text-xl font-bold tracking-tight">LifeMed</h1>
</div>
<div className="px-4 py-2">
<div className="flex items-center gap-3 px-3 py-2">
<div className="bg-center bg-no-repeat aspect-square bg-cover rounded-full size-10 ring-2 ring-primary/20" data-alt="Portrait of Dr. Silva" style={{backgroundImage: 'url(\'/logo.svg\')'}}></div>
<div className="flex flex-col">
<h2 className="text-text-main text-sm font-bold">Dr. Silva</h2>
...
<div>
<p className="text-sm font-bold text-text-main">Precisa de ajuda?</p>
<p className="text-xs text-text-secondary mt-1">Fale com nosso suporte técnico.</p>
</div>
</div>
</div>
</div>
...
<div className="bg-center bg-no-repeat aspect-square bg-cover rounded-full size-9 ring-2 ring-white shadow-sm cursor-pointer" data-alt="User profile picture" style={{backgroundImage: 'url(\'/logo.svg\')'}}></div>
</div>
</header>
...
<span className="text-text-main font-semibold">Pacientes</span>
</nav>
<div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
<div className="flex flex-col gap-2">
<h1 className="text-3xl lg:text-4xl font-extrabold text-text-main tracking-tight">Pacientes</h1>
<p className="text-text-secondary max-w-xl">Gerencie o cadastro e visualize o status de agendamento dos seus pacientes.</p>
</div>
...
<span className="text-xs font-semibold uppercase tracking-wider text-text-secondary mb-1">Agendados Hoje</span>
<div className="flex items-center gap-2">
<span className="text-2xl font-bold text-text-main group-hover:text-primary transition-colors">12</span>
<span className="text-xs bg-primary/10 text-primary px-1.5 py-0.5 rounded font-medium">+2</span>
</div>
</button>
<button className="group flex flex-col items-start min-w-[160px] p-4 rounded-xl bg-surface border border-border-color hover:border-primary hover:shadow-md transition-all cursor-pointer text-left">
<span className="text-xs font-semibold uppercase tracking-wider text-text-secondary mb-1">Futuro</span>
<div className="flex items-center gap-2">
<span className="text-2xl font-bold text-text-main group-hover:text-primary transition-colors">450</span>
</div>
</button>
<button className="group flex flex-col items-start min-w-[160px] p-4 rounded-xl bg-surface border border-border-color hover:border-primary hover:shadow-md transition-all cursor-pointer text-left">
<span className="text-xs font-semibold uppercase tracking-wider text-text-secondary mb-1">Sem Agendamento</span>
<div className="flex items-center gap-2">
<span className="text-2xl font-bold text-text-main group-hover:text-primary transition-colors">89</span>
...
<span className="material-symbols-outlined text-[18px]">filter_list</span>
                                    Status
                                    <span className="material-symbols-outlined text-[18px] text-text-secondary">arrow_drop_down</span>
</button>
<button className="h-10 px-3 py-1.5 rounded-lg border border-border-color bg-white text-text-main text-sm font-medium hover:bg-background-light flex items-center gap-2 whitespace-nowrap">
                                    Tags
                                    <span className="material-symbols-outlined text-[18px] text-text-secondary">arrow_drop_down</span>
...
<div className="flex flex-col">
<span className="font-bold text-text-main group-hover:text-primary transition-colors cursor-pointer">Ana Silva</span>
<span className="text-xs text-text-secondary">ID: #49201</span>
</div>
</div>
</td>
<td className="p-4">
<div className="flex flex-col">
<span className="text-text-main">(11) 9****-1234</span>
<span className="text-xs text-text-secondary">ana.silva@email.com</span>
</div>
</td>
<td className="p-4">
<div className="flex items-center gap-2">
...
<div className="flex flex-col">
<span className="font-medium text-text-main">14 Out, 10:00</span>
<span className="text-xs text-green-600 font-medium">Confirmado</span>
</div>
</div>
</td>
<td className="p-4 hidden md:table-cell">
<span className="text-text-secondary">10 Set 2023</span>
</td>
...
<td className="p-4">
<div className="flex items-center gap-3">
<div className="bg-center bg-no-repeat aspect-square bg-cover rounded-full size-10" data-alt="Portrait of Carlos Mendez" style={{backgroundImage: 'url(\'/logo.svg\')'}}></div>
<div className="flex flex-col">
<span className="font-bold text-text-main group-hover:text-primary transition-colors cursor-pointer">Carlos Mendez</span>
<span className="text-xs text-text-secondary">ID: #49205</span>
</div>
</div>
</td>
<td className="p-4">
<div className="flex flex-col">
<span className="text-text-main">(21) 9****-9876</span>
<span className="text-xs text-text-secondary">carlos.m@email.com</span>
</div>
</td>
<td className="p-4">
<div className="flex items-center gap-2">
...
<div className="flex flex-col">
<span className="font-medium text-text-main">15 Out, 14:30</span>
<span className="text-xs text-orange-600 font-medium">Aguardando Confirmação</span>
</div>
</div>
</td>
<td className="p-4 hidden md:table-cell">
<span className="text-text-secondary">02 Ago 2023</span>
</td>
<td className="p-4 hidden lg:table-cell">
<span className="px-2 py-0.5 rounded bg-gray-100 text-gray-600 text-xs font-bold border border-gray-200">Convênio</span>
</td>
<td className="p-4 text-right">
<button className="p-1.5 rounded-lg text-text-secondary hover:bg-white hover:shadow-sm hover:text-text-main transition-all">
<span className="material-symbols-outlined">more_vert</span>
...
<div className="flex flex-col">
<span className="font-bold text-text-main group-hover:text-primary transition-colors cursor-pointer">Mariana Jones</span>
<span className="text-xs text-text-secondary">ID: #49210</span>
</div>
</div>
</td>
<td className="p-4">
<div className="flex flex-col">
<span className="text-text-main">(41) 9****-5544</span>
<span className="text-xs text-text-secondary">mari.jones@email.com</span>
</div>
</td>
<td className="p-4">
...
<td className="p-4 hidden md:table-cell">
<span className="text-text-secondary">Ontem</span>
</td>
<td className="p-4 hidden lg:table-cell">
...
<td className="p-4 hidden md:table-cell"><div className="h-4 w-20 bg-gray-200 rounded"></div></td>
<td className="p-4 hidden lg:table-cell"><div className="h-6 w-16 bg-gray-200 rounded"></div></td>
<td className="p-4"></td>
</tr>
</tbody>
</table>
...
<p className="text-sm text-text-secondary">Mostrando <span className="font-bold text-text-main">1-3</span> de <span className="font-bold text-text-main">492</span> pacientes</p>
<div className="flex items-center gap-2">
...
<button className="size-9 flex items-center justify-center rounded-lg bg-primary text-text-main font-bold text-sm shadow-sm">1</button>
<button className="size-9 flex items-center justify-center rounded-lg border border-border-color text-text-secondary hover:bg-background-light text-sm font-medium">2</button>
<button className="size-9 flex items-center justify-center rounded-lg border border-border-color text-text-secondary hover:bg-background-light text-sm font-medium">3</button>
<span className="text-text-secondary px-1">...</span>
<button className="size-9 flex items-center justify-center rounded-lg border border-border-color text-text-secondary hover:bg-background-light text-sm font-medium">10</button>
...
{/*Backdrop*/}
<div className="absolute inset-0 bg-background-dark/20 backdrop-blur-sm transition-opacity" onclick="document.getElementById('newPatientDrawer').classList.add('translate-x-full')"></div>
{/*Drawer Panel*/}
...
<h2 className="text-lg font-bold text-text-main">Novo Paciente</h2>
...
<span className="text-xs text-text-secondary font-medium">Adicionar foto</span>
</div>
...
<div className="flex flex-col gap-1.5">
<label className="text-sm font-bold text-text-main">Celular <span className="text-red-500">*</span></label>
...
<div className="flex flex-col gap-1.5">
<label className="text-sm font-bold text-text-main">Data de Nasc.</label>
...
<div className="flex flex-col gap-1.5">
<label className="text-sm font-bold text-text-main">CPF / Documento</label>
...
<div className="flex flex-col gap-1.5">
<label className="text-sm font-bold text-text-main">Tags iniciais</label>
...
<div className="flex flex-col gap-1.5">
<label className="text-sm font-bold text-text-main">Observações (Admin)</label>
<textarea className="w-full p-4 rounded-lg bg-background-light border-transparent focus:bg-white focus:border-primary focus:ring-0 text-sm resize-none" placeholder="Informações internas..." rows="3"></textarea>
</div>
</div>
</div>
{/*Footer*/}
<div className="p-6 border-t border-border-color bg-surface flex gap-3">
<button className="flex-1 h-12 rounded-lg border border-border-color text-text-main font-bold hover:bg-background-light transition-colors" onclick="document.getElementById('newPatientDrawer').classList.add('translate-x-full')">Cancelar</button>
